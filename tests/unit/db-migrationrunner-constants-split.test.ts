...
describe("migrationRunner/constants — large-table integrity", () => {
  it("RENAMED_MIGRATION_COMPATIBILITY has 15 well-formed entries", () => {
    assert.equal(RENAMED_MIGRATION_COMPATIBILITY.length, 15);
  ...
  it("RENAMED_MIGRATION_COMPATIBILITY spot-checks the boundary renames", () => {
    ...
    assert.deepEqual(RENAMED_MIGRATION_COMPATIBILITY.slice(-5), [
      {
        fromVersion: "135",
