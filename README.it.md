...
| `diegosouzapw/omniroute` | `0.8.8`  | ~250MB     | Versione attuale        |
...
- OmniRoute v0.8.8+ include validazione fallback tramite chat completions
...
- **Runtime**: Node.js 20+
- **Linguaggio**: TypeScript 5.9 — **100% TypeScript** in `src/` e `open-sse/` (v0.8.8)
