...
export default function HomePage() {
  ...
  const [demoReply, setDemoReply] = useState(
    "A resposta aparece aqui. Se uma API key demo estiver configurada, o teste fala com a plataforma real."
  );
  ...
  async function runDemo(event: React.FormEvent) {
    event.preventDefault();
    setDemoLoading(true);
    setDemoReply("Chamando a plataforma...");
    try {
      ...
      <section id="top" className="shell hero">
        ...
        <div id="teste" className="chat-card">
          ...
          <div className="bubble ai">
            Oi! Sou o teste da Easy IA. Posso responder usando um combo da sua plataforma.
          </div>
