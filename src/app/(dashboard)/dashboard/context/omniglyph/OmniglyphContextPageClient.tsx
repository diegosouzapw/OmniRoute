    ...
    <div className="mx-auto flex max-w-4xl flex-col gap-6 p-6" data-testid="omniglyph-page">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="max-w-2xl text-sm text-text-muted">
          ...
          compact PNG pages that Claude Fable 5 reads instead of the text — image tokens are billed
          by dimensions, not characters, so the converted block costs ~10× less. Direct Anthropic
          route only.
        </p>
      </div>
