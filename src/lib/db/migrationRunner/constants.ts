...
export const PHYSICAL_SCHEMA_SENTINELS = [
  { version: "131", tableName: "proxy_subscriptions", description: "proxy_subscriptions table" },
  {
    version: "126",
    tableName: "reasoning_routing_rules",
    description: "reasoning_routing_rules table",
  },
  { version: "117", tableName: "proxy_pool_rotation", description: "proxy_pool_rotation table" },
  { version: "100", tableName: "cli_access_tokens", description: "cli_access_tokens table" },
  { version: "088", tableName: "quota_groups", description: "quota_groups table" },
  { version: "085", tableName: "quota_pools", description: "quota_pools table" },
  { version: "071", tableName: "version_manager", description: "version_manager table" },
  { version: "068", tableName: "free_proxies", description: "free_proxies table" },
  {
    version: "064",
    tableName: "session_model_history",
    description: "session_model_history table",
  },
  { version: "046", tableName: "database_settings", description: "database_settings table" },
  { version: "042", tableName: "compression_combos", description: "compression_combos table" },
  {
    version: "041",
    tableName: "session_account_affinity",
    description: "session_account_affinity table",
  },
  { version: "035", tableName: "cost_analysis_logs", description: "cost_analysis_logs table" },
  { version: "030", tableName: "mcp_scopes", description: "mcp_scopes table" },
