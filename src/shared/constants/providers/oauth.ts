...
export const OAUTH_PROVIDERS = {
  ...
  clinepass: {
    ...
    riskNoticeVariant: "oauth",
    authHint:
      "ClinePass is Cline's $9.99/mo subscription bundling 10 open coding models. Sign in with your Cline account (same login as the Cline CLI/IDE); a ClinePass subscription unlocks the cline-pass/* models. Reuses the Cline WorkOS OAuth flow.",
  },
  windsurf: {
    id: "windsurf",
    alias: "ws",
