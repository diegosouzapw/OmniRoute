// Auto-extracted from src/shared/constants/providers.ts on release/v3.8.36.
// Block: APIKEY_PROVIDERS | Lines: 650-2478 (~1,828 LOC, 53% of the parent file)
// Rationale: APIKEY_PROVIDERS is the largest single block in the parent file
// and has no closure dependencies on other module-level declarations. Splitting
// it to a co-located file makes the parent navigable and reduces git diff churn
// when a single provider is added/removed.
// Ref: see src/shared/constants/providers.ts top-of-file comment for split rationale.
