...
**Owner**: `@KooshaPari/core` (security-circle lead).
...
| **D** | M — Image gen is $expensive | Per-key cost-budget middleware (`src/lib/middleware/costBudget.ts`, added in [pheno-mcp-router#1]) |
| **E** | L | |
