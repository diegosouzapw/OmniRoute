...
| 3   | `open-sse/services/compression/toolResultCompressor.ts`      |  10.00% |
| 4   | `src/app/docs/components/DocCodeBlocks.tsx`                  |  10.63% |
| 5   | `open-sse/services/compression/engines/rtk/lineFilter.ts`    |  10.96% |
| 6   | `open-sse/services/specificityRules.ts`                      |  11.28% |
| 7   | `src/mitm/systemCommands.ts`                                 |  12.19% |
| 8   | `open-sse/services/compression/aggressive.ts`                |  12.77% |
| 9   | `src/app/api/v1/batches/[id]/cancel/route.ts`                |  12.98% |
| 10  | `open-sse/services/compression/progressiveAging.ts`          |  13.26% |
| 11  | `open-sse/services/compression/engines/rtk/smartTruncate.ts` |  13.43% |
| 12  | `open-sse/services/compression/engines/rtk/deduplicator.ts`  |  13.51% |
| 13  | `src/lib/cloudAgent/agents/jules.ts`                         |  13.52% |
| 14  | `open-sse/services/compression/lite.ts`                      |  14.46% |
| 15  | `src/app/api/v1/rerank/route.ts`                             |  14.94% |
| 16  | `open-sse/services/compression/preservation.ts`              |  15.07% |
| 17  | `src/lib/cloudAgent/agents/codex.ts`                         |  15.54% |
| 18  | `open-sse/services/tierResolver.ts`                          |  16.66% |
| 19  | `src/app/docs/components/DocsLazyWrapper.tsx`                |  16.66% |
