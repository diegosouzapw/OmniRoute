...
| Module                           | Purpose                                                                |
| -------------------------------- | ---------------------------------------------------------------------- |
| `constants/providers.ts`         | **356 providers** with Zod validation (source of truth)                |
...
| `PROVIDER_REFERENCE.md`     | **Auto-generated** catalog of 356 providers (regen: `npm run gen:provider-reference`) |
