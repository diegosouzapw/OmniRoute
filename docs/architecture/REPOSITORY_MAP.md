...
| `app/(dashboard)/dashboard/costs/quota-share/`                               | Quota Sharing page (Group B): `QuotaSharePageClient.tsx` + `components/{PoolCard,DimensionBar,AllocationTable,BurnRateChart,QuotaConceptCard,PoolWizard}.tsx` + `hooks/{usePools,usePoolUsage,useLocalStoragePoolMigration}.ts`                                                                                    |
...
| `freeProxyProviders/`, `db/freeProxies.ts` | Free proxy marketplace sources and persistence — see `docs/ops/PROXY_GUIDE.md`                                                                                                                                                                                                                                          |
