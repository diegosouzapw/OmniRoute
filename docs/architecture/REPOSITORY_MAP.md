...
| `omnicontext/`                           | Continuity Plane (team-scoped artifacts, handoffs, inject/retrieve, SCIM push stub) — see `docs/frameworks/OMNICONTEXT.md`                                                                                                                                                                                              |
| `memory/embedding/`                      | Multi-source embedding layer: `index.ts` (resolver), `remote.ts`, `staticPotion.ts`, `transformersLocal.ts`, `cache.ts`, `types.ts` (plan 21). OmniContext may opt into this via `embedSource: "memory-auto"`.                                                                                                          |
