...
│                         Node.js process bootstrap (env, DB, jobs, sync)
...
| `acp/`            | Agent-Control-Protocol CLI discovery registry: `registry.ts`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| `skills/`         | Skill framework: `registry.ts`, `executor.ts`, `interception.ts`, `injection.ts`, `sandbox.ts`, `builtins.ts`, `providerSettings.ts`, `schemas.ts`, `skillssh.ts`, `types.ts`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
`modelComboMappings.ts`, `models.ts`, `oneproxy.ts`,
