...
<img src="./docs/diagrams/readme-hero.svg" width="100%" alt="OmniRoute — Aldri slutt å kode. Hvert AI-verktøy → 359 leverandører — 150+ gratis — gjennom ett endepunkt. Claude Code, Codex, Cursor, Cline, Copilot & Antigravity inn i GRATIS Claude / GPT / Gemini med automatisk tilbakefall. RTK + Caveman stablet komprimering sparer 15–95% tokens (~89% i snitt) — treffer aldri grenser. 359 AI-leverandører · 150+ gratis nivåer · ~1.62B gratis tokens/mnd · 19 rutingstrategier · $0 å starte."/>
...
<img src="./docs/diagrams/why-pain-fix.svg" width="100%" alt="Hvorfor OmniRoute — slutt å sjonglere 10 dashbord, døde API-nøkler og overraskende regninger. Ti daglige problemer vs. løsninger: ubrukt kvote utløper → maksimer abonnementer; hastighetsbegrensninger midt i kodingen → 4-nivåers automatisk tilbakefall (Abonnement → API → Billig → Gratis); verktøyutganger brenner tokens → RTK + Caveman-komprimering (15–95 %); dyre API-er → kostnadsoptimalisert ruting; hvert verktøy sitt eget oppsett → ett endepunkt, ett dashbord; AI blokkert → 3-nivåers proxy + TLS stealth; døde nøkler → 3-lags robusthet (strømbrytere, nøkkelnedkjøling, modellås); team deler ett abonnement → nøkkelpuljer med rettferdig fordeling av kvoter; prompter gjennom noens sky → lokalt først med AES-256-GCM-krypterte nøkler; ingen forbrukssynlighet → live analyse (bruk, kvote, besparelser, p95 latens)."/>
...
<img src="./docs/diagrams/comparison-table.svg" width="100%" alt="Hva skiller OmniRoute ut – et datert funksjonsøyeblikksbilde vs 9router, OpenRouter, CLIProxyAPI og LiteLLM på tvers av 13 funksjoner. OmniRoute: 359 leverandører, 150+ innebygde gratistjenester, 19 rutingstrategier, 12-motorers token-komprimering, innebygd MCP-server med 110 verktøy, A2A agentprotokoll, vedvarende minne, sikkerhetsbarrierer, skyagenter, TLS-fingeravtrykk-stealth, Desktop/Termux/PWA og 42 i18n UI-lokaler. OmniRoute er MIT-lisensiert og kan selv-hostes. Konkurrentfunksjoner og antall kan endres; se den lenkede metodikken."/>

<sub>📊 Full metodikk og detaljer per funksjon vs 9router, OpenRouter, CLIProxyAPI & LiteLLM → [`docs/comparison/OMNIROUTE_VS_ALTERNATIVES.md`](docs/comparison/OMNIROUTE_VS_ALTERNATIVES.md)</sub>
