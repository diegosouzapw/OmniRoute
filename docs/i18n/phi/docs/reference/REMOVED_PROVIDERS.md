...
| Tinanggal noong | Provider id | Alias  | Mga Domain                                       | Hiniling ni                                | Removal PR                                                     | Mga Tala                                                                                                                                                                                                                                                                                                                                                                            |
| --------------- | ----------- | ------ | ------------------------------------------------ | ------------------------------------------ | -------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-08-12      | `puter`     | `pu`   | `puter.com`                                      | May-ari ng Puter (Nariman Jelveh)          | [#10210](https://github.com/diegosouzapw/OmniRoute/pull/10210) | API-key provider. Nililinis ng migration `152_remove_puter_provider.sql` ang nakaimbak na config.                                                                                                                                                                                                                                                                                   |
| 2026-09-02      | `theoldllm` | `tllm` | `theoldllm.com`, `theoldllm.vercel.app`          | Ang operator ng serbisyo (support email)   | [#12440](https://github.com/diegosouzapw/OmniRoute/pull/12440) | Keyless provider. Natanggap ang nakasulat na kahilingan noong 2026-08-30. Tinanggal ang mga nakalaang isyu at diskusyon, muling pinamagatan ang mga PR.                                                                                                                                                                                                                             |
| 2026-09-21      | `suno`      | `suno` | `studio-api.suno.ai`, `studio-api-prod.suno.com` | Desisyon ng may-ari ng proyekto (`#14224`) | [#14468](https://github.com/diegosouzapw/OmniRoute/pull/14468) | Cookie-auth provider, hindi isang operator takedown. Ang `studio-api.suno.ai` ay sinuspinde (503); ang live host ay nangangailangan ng Clerk JWT exchange plus isang bayad na hCaptcha-solving dependency na pinili ng OmniRoute na huwag idagdag para sa isang music provider. Ang `kie/suno-v4.0` at `kie/suno-v3.5` (kie.ai-hosted) ay hindi apektado at nananatiling suportado. |
