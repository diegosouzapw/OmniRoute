...
Registru: `open-sse/config/providers/registry/cursor/index.ts`
(`cursor_apiProvider`, `authType: "apikey"`, aceleași `format`, `baseUrl` și
`models` ca pentru `cursor`). Card de catalog:
`src/shared/constants/providers/apikey/specialty-media.ts`. Maparea executorilor:
