...
Dodatak je npm paket nazvan `omniroute-cmd-<name>` (ili `@scope/omniroute-cmd-<name>`).

```
omniroute-cmd-myplugin/
├── package.json     # mora imati "type": "module" i "main": "index.mjs"
├── index.mjs        # eksportuje register(program, ctx) + opcionalne meta podatke
└── README.md
```
