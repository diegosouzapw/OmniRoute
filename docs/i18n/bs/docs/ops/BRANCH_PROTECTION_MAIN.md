# BRANCH_PROTECTION_MAIN (Bosanski)
...
# Zaštita grane — `main` (OpenSSF Scorecard: Branch-Protection)

Radnja vlasnika. Primijenite putem Settings → Branches → Add rule, ili:
...
Podiže Scorecard Branch-Protection sa 0. `enforce_admins:false` održava postojeći tok forward-merge-a funkcionalnim; pooštrite na `true` kada postane stabilno.
