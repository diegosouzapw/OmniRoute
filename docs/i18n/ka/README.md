...
<img src="./docs/diagrams/readme-hero.svg" width="100%" alt="OmniRoute — არასოდეს შეწყვიტო კოდირება. ყველა AI ინსტრუმენტი → 359 პროვაიდერი — 150+ უფასო — ერთი ენდპოინტის გავლით. Claude Code, Codex, Cursor, Cline, Copilot & Antigravity უფასო Claude / GPT / Gemini-ში ავტომატური უკან დაბრუნებით. RTK + Caveman დასტა შეკუმშვა ზოგავს 15–95% ტოკენს (~89% საშუალოდ) — არასოდეს მიაღწიოთ ლიმიტებს. 359 AI პროვაიდერი · 150+ უფასო დონე · ~1.62B უფასო ტოკენი/თვეში · 19 მარშრუტიზაციის სტრატეგია · $0 დასაწყებად."/>
...
<sub>📦 დააკოპირეთ და ჩასვით სწრაფი დაწყების სკრიპტები **Python, Node.js, PHP და cURL-ისთვის** → [`examples/quickstart/`](examples/quickstart/)</sub>
...
<img src="./docs/diagrams/promise-pillars.svg" width="100%" alt="დაპირება — ერთი ენდპოინტი და 359 პროვაიდერი. ავტომატური უკანდახევა ინარჩუნებს მარშრუტიზაციას, სანამ ხელმისაწვდომია სხვა ჯანსაღი სამიზნე. ექვსი საყრდენი: მდგრადი უკანდახევა 359 პროვაიდერზე · 95%-მდე ტოკენის დაზოგვა შესაბამის სამუშაო დატვირთვებზე · $0 დასაწყებად 150+ უფასო დონით და 54 განმეორებადი/გასაღების გარეშე სამუდამოდ უფასო პროვაიდერით · 36 CLI/აგენტის ინტეგრაცია ერთი კონფიგურაციით · OpenAI, Claude, Gemini და Responses API თავსებადობა /v1-ზე · წარმოების კონტროლი, მათ შორის ამომრთველები, TLS სტელსი, MCP 110 ხელსაწყოები, A2A, მეხსიერება, დამცავი ზოლები, შეფასებები და 39,000+ სტატიკური ტესტის დეკლარაცია 5,100+ თვალყურის დევნებულ სატესტო ფაილში."/>
...
<img src="./docs/diagrams/why-pain-fix.svg" width="100%" alt="რატომ OmniRoute — შეწყვიტეთ 10 დაფის, მკვდარი API გასაღებების და მოულოდნელი გადასახადების ჟონგლირება. ათი ყოველდღიური პრობლემა vs გადაწყვეტა: გამოუყენებელი კვოტის ვადის გასვლა → გამოწერების მაქსიმიზაცია; სიჩქარის ლიმიტები კოდირებისას → 4-დონიანი ავტომატური უკანდახევა (გამოწერა → API → იაფი → უფასო); ხელსაწყოს გამომავალი ტოკენების დაწვა → RTK + Caveman შეკუმშვა (15–95%); ძვირი API-ები → ხარჯების ოპტიმიზებული მარშრუტიზაცია; ყოველი ხელსაწყო თავისი დაყენებით → ერთი ენდპოინტი, ერთი დაფა; AI დაბლოკილია → 3-დონიანი პროქსი + TLS სტელსი; მკვდარი გასაღებები → 3-დონიანი მდგრადობა (ამომრთველები, გასაღების გაგრილება, მოდელის დაბლოკვა); გუნდი იზიარებს ერთ გამოწერას → გასაღებების პულები სამართლიანი წილის კვოტებით; მოთხოვნები სხვისი ღრუბლის გავლით → ლოკალური პირველ რიგში AES-256-GCM დაშიფრული გასაღებებით; ხარჯების ხილვადობის არარსებობა → ცოცხალი ანალიტიკა (გამოყენება, კვოტა, დაზოგვა, p95 ლატენტურობა)."/>

<div align="center">

<img src="./docs/diagrams/tier-cascade.svg" width="100%" alt="OmniRoute მოთხოვნის ნაკადი: თქვენი IDE ან CLI (Claude Code, Cursor, Cline…) იძახებს ერთ ლოკალურ ენდპოინტს (http://localhost:20128/v1); OmniRoute Smart Router-ს (RTK + Caveman შეკუმშვა, 19 მარშრუტიზაციის სტრატეგია, ამომრთველები, TLS სტელსი, MCP, A2A, დამცავი ზოლები) შეუძლია უკან დაიხიოს 4 პროვაიდერის დონეზე, სანამ რჩება შესაბამისი ჯანსაღი სამიზნე — დონე 1 გამოწერა, დონე 2 API გასაღები, დონე 3 იაფი და დონე 4 უფასო."/>
