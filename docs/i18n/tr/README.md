...
## 💰 Aylık ~1,62 Milyar Ücretsiz Token

</div>

> Ücretsiz katmanları elle bir araya getirmek zahmetlidir — düzinelerce SDK, düzinelerce hız sınırı ve gerçekte ne kadar kotanız olduğuna dair hiçbir fikriniz yoktur. OmniRoute, **35 yinelenen havuz anahtarında 489 ücretsiz katman girdisini** kataloglar ve token manşetini, **yayınlanmış pozitif aylık bütçeye sahip 17 havuz ile modele özel beş Groq sınırından**, paylaşılan havuzlara göre tekilleştirerek hesaplar. Yalnızca bölgesel kimlik kontrolünden sonra kullanılabilen kotalar (şu anda: ModelScope) ayrı gösterilir; bölgesel kimlik doğrulamasının arkasındaki +~6M hiçbir zaman manşetteki toplama dahil edilmez. Sonuç, kontrol panelinde (`/dashboard/free-tiers`) görünür kalır.

<img src="./docs/diagrams/free-tier-budget.svg" width="100%" alt="OmniRoute ücretsiz katman bütçe kartı: aylık düzenli ~1,62 milyar ücretsiz token, kayıt kredileriyle ilk ayda ~2,22 milyara kadar; tek bir uç noktanın arkasındaki, kataloglanmış 489 ücretsiz katman girdisini kapsayan, belgelenmiş 35 yinelenen havuz anahtarından elde edilir. Dürüst, havuz bazında tekilleştirilmiş hesaplama — yayınlanmış pozitif aylık token bütçesine sahip 17 yinelenen havuz ve modele özel beş Groq sınırı dahil olmak üzere her paylaşılan havuz yalnızca bir kez sayılır; koşul riski kataloğunda 13 sağlayıcı kaçınılması gereken olarak işaretlenmiştir, böylece kararı siz verirsiniz. Bütçe çubuğu Mistral 1B, Nara 210M, LLM7 150M, xKiro 150M, Groq 30M (modele özel beş sınır) ve daha küçük havuzların yanı sıra ilk aya özel kayıt kredilerini içerir; kalıcı olarak ücretsiz ve token sınırı olmayan sağlayıcılar ise manşeti hiçbir zaman yapay olarak yükseltmemeleri için ayrı gösterilir. Canlı kullanılan/kalan miktarlar /dashboard/free-tiers üzerinde."/>
...
>
> <sub>Bu rakamlar, canlı kataloğa göre iki haftada bir yeniden denetlenir ve **her iki yönde de değişir** — bir sağlayıcı ücretsiz katmanını sonlandırırsa sayı düşer; yenisi eklenirse yükselir. Yuvarlanarak artırılmış en iyi senaryoyu değil, kataloğun gerçekte hesapladığı değeri yayınlarız.</sub>
...
⭐ OMNIROUTE para tasarrufu yapmanıza ve işinizi kolaylaştırmanıza yardımcı olduysa depoya yıldız verin.
...
**👋 Proje yöneticisini takip edin — yeni sağlayıcılardan, sürümlerden ve ipuçlarından ilk siz haberdar olun:**
...
[![@diegosouzapw'yi GitHub'da takip edin](https://img.shields.io/github/followers/diegosouzapw?style=for-the-badge&logo=github&logoColor=white&label=Follow%20on%20GitHub&color=181717)](https://github.com/diegosouzapw)
...
<table>
  ...
  <tr><td nowrap>🖐 <b>Liberapay</b></td><td>Tekrarlayan · kar amacı gütmeyen · açık kaynak</td><td><a href="https://liberapay.com/diegosouzapw">liberapay.com/diegosouzapw</a></td></tr>
  <tr><td nowrap>🇧🇷 <b>PIX</b> (Brezilya)</td><td>Anında, masrafsız</td><td>anahtar ve QR aşağıda</td></tr>
  <tr><td nowrap>₿ <b>Kripto</b></td><td>BTC · ETH · USDT-TRC20 · USDC-Solana</td><td>adresler aşağıda</td></tr>
</table>
...
<details>
<summary><b>₿ Kripto</b> — BTC · ETH · USDT-TRC20 · USDC-Solana (genişletmek için tıklayın)</summary>
...
<sub>⚠️ Her coini yalnızca gösterilen ağ üzerinden gönderin — yanlış ağda göndermek fonların kaybolmasına neden olabilir.</sub>
...
## 🤖 Uyumlu CLI'lar ve Kodlama Aracıları

> Tek bir yapılandırmayla — `http://localhost:20128/v1` — **tüm** yapay zekâ IDE'leri veya CLI'ları ücretsiz ve düşük maliyetli modellerde çalışır.
...
<sub>📖 36 aracın tamamı için araç bazında kurulum (26 CLI Code + 10 CLI Agent) → [`docs/reference/CLI-TOOLS.md`](docs/reference/CLI-TOOLS.md) · 🧩 OpenCode eklentisi → [`@omniroute/opencode-provider`](https://www.npmjs.com/package/@omniroute/opencode-provider)</sub>
...
kimlik bilgileri süreç bazında eklenir, Qwen/Gemini geçici ve yalıtılmış bir ana dizin kullanır:
...
> Standart sohbet, medya, arama, yerel, bulut aracısı ve sistem koleksiyonlarında **357 kayıtlı sağlayıcı** bulunuyor; bunların **152'si `hasFree: true` keşif meta verisini taşıyor**. Sohbet modeli kaydı **229 sağlayıcıyı / 2.554 farklı sağlayıcı-model çiftini / 1.283 ham model kimliğini** kapsıyor; ayrı ücretsiz kullanım bütçesi kataloğunda ise **model başına 491 satır**, **35 yinelenen havuz** ve **54 yinelenen/anahtarsız, süresiz ücretsiz sağlayıcı** bulunuyor. Bunlar tasarım gereği farklı paydalardır; tanımlar ve havuz tekilleştirmeli hesaplamalar [Sağlayıcı Referansı](docs/reference/PROVIDER_REFERENCE.md) ve [Ücretsiz Katmanlar](docs/reference/FREE_TIERS.md) belgelerinde yer alır.
...
<sub>…ve 330'dan fazlası — her simge, kontrol panelinin sağlayıcı kataloğundan canlı olarak çözümlenir. 📖 [Sağlayıcı Referansı](docs/reference/PROVIDER_REFERENCE.md)</sub>
...
<table>
  ...
  <tr>
    ...
    <td align="center" width="150"><img src="./public/openference.svg" width="42" alt="Openference"/><br/><b>Openference</b><br/><sub>Qwen3.8 27B, Llama 3.2<br/>Ücretsiz katman</sub></td>
...
## 🖥️ OmniRoute Nerede Çalışır — Her Yerde
...
### 🧩 Yeni: VS Code'un yerel Copilot Chat'i içinde OmniRoute
...
> Sunucunun ötesinde, OmniRoute **80'den fazla komuta** sahip **kapsamlı bir komut satırı kokpitidir**; ayrıca bir yapay zeka ajanının onu **kendi başına** yönetebilmesi için açık ajan protokollerine sahiptir.

### ⌨️ Gerçek bir CLI (yalnızca `start` değil)

```bash
omniroute               # ağ geçidini + panoyu sunar (port 20128)
omniroute chat          # etkileşimli TUI sohbet istemcisi (komutlar: /model /combo /skill /memory)
omniroute setup         # rehberli ilk çalıştırma sihirbazı
omniroute doctor        # sağlayıcıları, portları ve yerel bağımlılıkları denetler
```

### 🛰️ Uzak mod — CLI'ı burada, OmniRoute'u bir VPS üzerinde çalıştırın

OmniRoute bir sunucuda mı kurulu? Dizüstü bilgisayarınızdan **aynı CLI** ile yönetin. Kapsamlı bir erişim tokenıyla bir kez oturum açın; ardından her komut uzak sunucuyu hedefler.

```bash
omniroute connect 192.168.0.15            # şifre → kapsamlı token, bağlam olarak kaydedilir
omniroute models list                     # ← UZAK sunucuya karşı çalışır
omniroute configure codex                 # ← uzak bir model seçer, yerel bir Codex profili yazar
omniroute tokens create --name ci --scope read   # diğer makineler için daha dar kapsamlı tokenlar üretir
omniroute contexts use default            # ← yerel sunucuya geri döner
```
...
### 🤝 Bir ajan bağlayın — ve OmniRoute'un kendisini yönetsin
...
<table>
  ...
  <tr><td align="left" nowrap>🧰 <b>MCP (stdio)</b></td><td align="left" nowrap><code>omniroute --mcp</code></td><td align="left">Claude Desktop, Cursor veya herhangi bir MCP istemcisine bağlayın</td></tr>
  ...
  <tr><td align="left" nowrap>🛰️ <b>Uzak CLI</b></td><td align="left" nowrap><code>omniroute connect &lt;host&gt;</code></td><td align="left">Kapsamlı erişim tokenlarıyla uzak bir örneği yönetin</td></tr>
</table>

```bash
# Claude Code'a MCP üzerinden tam OmniRoute araç setini verin:
...
## 📦 Daha fazla kurulum yöntemi — Docker, kaynak kod, pnpm, Arch
...
```bash
OMNIROUTE_SKIP_POSTINSTALL=1 npm install -g omniroute   # CI=1 de bunu atlar
```

En hızlı kurulumlar için **pnpm** tercih edin (içerik adresli depolama + hard linkler — yukarıya bakın).
Panosuz, headless bir çalışma zamanı için Docker `base` profilini (yukarıda) veya
[Termux kılavuzunu](docs/guides/TERMUX_GUIDE.md) kullanın. CLI ve web panosu aynı port üzerinde
...
<sub>Sosyal medya verileri (2026-08-17) · YT: 741 | TT: 137 | IG: 124 · Tazelik (gün): YT 0 · TT 14 · IG 15</sub>
...
<table>
  <tr>
    <td align="center" width="320">
      ...
      <b>🎬 #1 — Instagram</b><br/>
      <sub>nick_saraev — 1.628.910 görüntüleme</sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🎬 #2 — YouTube</b><br/>
      <sub>Vaibhav Sisinty — 373.084 görüntüleme</sub>
    </td>
    <td align="center" width="320">
      ...
      <sub>Nick Automates — 207.714 görüntüleme</sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🎬 #4 — TikTok</b><br/>
      <sub>milesreevesai — 620.400 görüntüleme</sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🎬 #5 — YouTube</b><br/>
      <sub>Valency Labs — 135.974 görüntüleme</sub>
    </td>
  </tr>
</table>
...
**Tam sıralama (`v > 0`, en yüksek erişim):**
...
<table>
  ...
  <tr><td nowrap><b>Veritabanı</b></td><td>better-sqlite3 (SQLite, WAL günlük kaydı) + LowDB (eski JSON) — 122 etki alanı modülü, 178 geçiş</td></tr>
  <tr><td nowrap><b>Bellek</b></td><td>SQLite FTS5 tam metin + int8 ile nicelenmiş vektör gömmeleri, türü belirlenmiş azaltma</td></tr>
  ...
  <tr><td nowrap><b>Dayanıklılık</b></td><td>Devre kesici, üstel geri çekilme, eş zamanlı istek yığılmasını önleme, otomatik kombinasyonlu kendi kendini iyileştirme</td></tr>
  <tr><td nowrap><b>Günlük kaydı</b></td><td>pino — istek bağlamıyla yapılandırılmış JSON günlükleri</td></tr>
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/guides/REMOTE-MODE.md">Uzak Mod</a></b></td><td>Kapsamlı erişim belirteçleri aracılığıyla dizüstü bilgisayarınızdaki CLI üzerinden uzaktaki bir OmniRoute'u (VPS) yönetin</td></tr>
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/compression/COMPRESSION_ENGINES.md">Sıkıştırma Motorları</a></b></td><td>Caveman, RTK, yığınlı işlem hatları, pano/API/MCP yüzeyleri</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/architecture/RESILIENCE_GUIDE.md">Dayanıklılık Kılavuzu</a></b></td><td>Devre kesiciler, bekleme süreleri, kuyruk, istek yığılmasını önleme, TLS sahteciliği</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/architecture/CODEBASE_DOCUMENTATION.md">Kod Tabanı Dokümantasyonu</a></b></td><td>Yeni başlayanlara uygun kod tabanı rehberi</td></tr>
</table>
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/ops/BRANCHING_MODEL.md">Dallanma ve Sürüm Modeli</a></b></td><td>PR'lerin hedeflediği yer (<code>release/*</code>), <code>main</code> dalının ve etiketlerin anlamı</td></tr>
  <tr><td nowrap><b><a href="CHANGELOG.md">Değişiklik Günlüğü</a></b></td><td>Sürüm bazında tam sürüm geçmişi</td></tr>
  <tr><td nowrap><b><a href="SECURITY.md">Güvenlik Politikası</a></b></td><td>Güvenlik açığı bildirimi ve güvenlik uygulamaları</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/ops/COVERAGE_PLAN.md">Kapsama Planı</a></b></td><td>5.100'den fazla izlenen test dosyasındaki 39.000'den fazla statik test bildirimi için test kapsama stratejisi</td></tr>
</table>
...
<sub>2026-08-24 05:26:03 UTC tarihine kadarki birleştirmeler dâhil olmak üzere, canlı <code>release/v3.8.50</code> dalının <code>dafb4ae808</code> ucunda sabitlenmiştir. Sayfalandırılmış GitHub GraphQL sayımı, birleştirilmiş 5.911 PR içerir: 2.707'si depo sahibi, 179'u Dependabot ve <b>3.025 harici PR ise 535 farklı katkıda bulunan</b> tarafından oluşturulmuştur. “Değiştirilen satır”, GitHub eklemeleri + silmelerinin toplamıdır ve oluşturulan dosyaları, kilit dosyalarını, katalogları, çevirileri ve belgeleri içerir; yazılmış LOC değil, kod değişim hacmidir. Eşik noktasındaki eşitlikler korunmuştur.</sub>
...
<table>
  <tr>
    ...
    <td align="center" width="160">
      ...
      <sub>🏅 GitHub tarafından ilişkilendirilen 69 commit · 6. sıra paylaşılıyor</sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="160">
    ...
    <td align="center" width="160">
      ...
      <sub>🏅 GitHub tarafından ilişkilendirilen 51 commit · 10. sıra paylaşılıyor</sub>
    </td>
    <td align="center" width="160">
...
<sub>2026-08-24 06:14:31 UTC tarihinde yeniden kontrol edildi: Deponun Katkıda Bulunanlar API'si tarafından varsayılan <code>release/v3.8.50</code> dalı için bildirilen, GitHub tarafından ilişkilendirilmiş commit'ler. API 525 kimlik (415 kullanıcı, 2 bot, 108 anonim) döndürdü; bu tablo bakım sorumlusunu, botları ve anonim kimlikleri hariç tutar ve eşitlikleri korur. Bu tablo, hem yukarıdaki birleştirilmiş PR sıralamasından hem de aşağıdaki 639 kişilik Git meta verisi sayımından farklıdır.</sub>

> 🙏 Bu katkıda bulunanların özellikleri, hata düzeltmeleri ve altyapı iyileştirmeleri, OmniRoute'u güvenilir ve özellik bakımından zengin kılan unsurların **temel bir parçasıdır**. Her pull request, her test senaryosu ve her i18n çeviri dosyası önemlidir. Açık kaynak, onlar gibi insanlar tarafından oluşturulur.
...
OmniRoute'u kendi bütçelerinden finanse eden kişilere içtenlikle teşekkür ederiz — her katkı projenin ücretsiz, bağımsız ve gelişmeye devam etmesini sağlar.
...
<b><a href="https://github.com/sponsors/diegosouzapw">💖 Sponsor olun →</a></b> — her bir dolar OmniRoute'un ücretsiz ve bağımsız kalmasını sağlar.
...
1. Depoyu forklayın
2. **Aktif** `release/vX.Y.Z` dalından (`main` değil) bir dal oluşturun — bkz. [Dallanma ve Sürüm Modeli](docs/ops/BRANCHING_MODEL.md)
3. Özellik dalınızı oluşturun (`git checkout -b feat/harika-ozellik`)
4. Değişikliklerinizi commit edin (`git commit -m 'feat: harika ozellik ekle'`)
5. Dalınıza push edin (`git push origin feat/harika-ozellik`)
6. **Hedef dal = ilgili `release/vX.Y.Z` dalı** olacak şekilde bir Pull Request açın
...
OmniRoute devlerin omuzlarında yükselmektedir. **[9router](https://github.com/decolua/9router)** projesinin bir çatalı ve Go projesi **[CLIProxyAPI](https://github.com/router-for-me/CLIProxyAPI)**'nin bir TypeScript uyarlaması olarak başladı — ve oradan itibaren aşağıdaki her alt sistem, oraya ilk ulaşan bir açık kaynak projesinden ilham aldı. Her biri OmniRoute'un somut bir parçasını şekillendirdi. Hepsine teşekkür ederiz. 🙏
...
<table>
  <tr><th align="left">Proje</th><th align="center">⭐</th><th align="left">OmniRoute'a nasıl ilham verdi</th></tr>
...
<table>
  ...
  <tr><td nowrap><b><a href="https://github.com/microsoft/LLMLingua">LLMLingua</a></b></td><td align="center">6.5k</td><td>İstem sıkıştırma araştırması (LLMLingua / LLMLingua-2) — asenkron, kod güvenli, başarısızlık durumunda açık (fail-open) <code>llmlingua</code> motorumuza ilham verdi.</td></tr>
  <tr><td nowrap><b><a href="https://github.com/atjsh/llmlingua-2-js">llmlingua-2-js</a></b></td><td align="center">30</td><td>LLMLingua motorumuz için çalışan iş parçacığı (worker-thread) arka ucu olarak kullanılan JS/ONNX portu (MobileBERT / XLM-RoBERTa).</td></tr>
  <tr><td nowrap><b><a href="https://github.com/leninejunior/troglodita">Troglodita</a></b></td><td align="center">26</td><td>PT-BR token sıkıştırması — pt-BR dil paketimize güç verir: Brezilya Portekizcesi gramerine göre ayarlanmış anlatım bozukluğu azaltma ve dolgu sözcük temizleme.</td></tr>
  <tr><td nowrap><b><a href="https://github.com/DietrichGebert/ponytail">ponytail</a></b></td><td align="center">86.0k</td><td>Viral olan "tembel kıdemli geliştirici" YAGNI kodlama yeteneği — <b>less-code</b> Çıktı Stilimize ilham verdi: _üretilen_ kodu azaltan çalışan en küçük değişiklik yönlendirmesi (Caveman'in kısa düz yazısının çıktı eksenindeki eşleniği).</td></tr>
</table>
...
<table>
  ...
  <tr><td nowrap><b><a href="https://github.com/Mibayy/token-savior">token-savior</a></b></td><td align="center">1.1k</td><td>Bash çıktısı sıkıştırması + MCP profilleri — sıkıştırmadan vazgeçme disiplinimize ve MCP araç bildirimi küçültmesine ilham verdi.</td></tr>
  <tr><td nowrap><b><a href="https://github.com/ppgranger/token-saver">token-saver</a></b></td><td align="center">117</td><td>Hata duyarlı vazgeçme özelliğine sahip içerik duyarlı, dosya türü başına çıktı sıkıştırması — tür başına dağıtımımızı ve minimum kazanç atlamamızı doğruladı.</td></tr>
  <tr><td nowrap><b><a href="https://github.com/alexgreensh/token-optimizer">token-optimizer</a></b></td><td align="center">1.7k</td><td>"Hayalet tokenları bulun" — boşaltma + kurtarılabilir tanıtıcı modeli CCR boşaltma düşüncemizi besledi.</td></tr>
  <tr><td nowrap><b><a href="https://github.com/Shweta-Mishra-ai/tokenmizer">TokenMizer</a></b></td><td align="center">16</td><td>Oturum grafiği + turlar arası satır tekilleştirme taslağı session-dedup tasarımımızı besledi.</td></tr>
  <tr><td nowrap><b><a href="https://github.com/jessefreitas/OmniCompress">OmniCompress</a></b></td><td align="center">3</td><td>Rust sütunlu JSON + içerik adresli geri getirme + mesajlar arası tekilleştirme — <code>headroom</code>/<code>ccr</code>/<code>session-dedup</code> motor tasarımımızı ve önbellek kararlı "sıkıştırılmış form konumdan bağımsızdır" kuralımızı doğruladı.</td></tr>
  <tr><td nowrap><b><a href="https://github.com/atlassian-labs/mcp-compressor">mcp-compressor</a></b></td><td align="center">98</td><td>MCP araç şeması/açıklama sıkıştırması — MCP araç bildirimi kardinalite azaltmamızı besledi.</td></tr>
  <tr><td nowrap><b><a href="https://github.com/pdavis68/RepoMapper">RepoMapper</a></b></td><td align="center">187</td><td>Aider tarzı depo haritası sıralaması — depo haritası / getirme sıralaması keşfimizi besledi.</td></tr>
  ...
  <tr><td nowrap><b><a href="https://github.com/dsherret/ts-morph">ts-morph</a></b></td><td align="center">6.1k</td><td>TypeScript Compiler API araç seti — dize, şablon ve regex sabit değerlerini koruyan ayrıştırıcı tabanlı yorum satırı temizlememize ilham verdi.</td></tr>
</table>
...
<table>
  ...
  <tr><td nowrap><b><a href="https://github.com/langfuse/langfuse">Langfuse</a></b></td><td align="center">31.4k</td><td>İzleme → aralık → üretim gözlemlenebilirlik modeli Sıkıştırma Stüdyosu şelale görünümümüzü şekillendirdi.</td></tr>
  <tr><td nowrap><b><a href="https://github.com/kiali/kiali">Kiali</a></b></td><td align="center">3.6k</td><td>Istio servis ağı (service-mesh) gözlemlenebilirliği — Yönlendirme/Kombo Stüdyosundaki devre kesici rozetlerimize ve hata kenarı görsellerimize ilham verdi.</td></tr>
  <tr><td nowrap><b><a href="https://github.com/lobehub/lobe-icons">lobe-icons</a></b></td><td align="center">2.2k</td><td>Panomuz genelinde sağlayıcı simgelerini oluşturan yapay zeka/LLM marka logoları.</td></tr>
</table>
