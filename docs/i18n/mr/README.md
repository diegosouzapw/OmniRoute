...
<img src="./docs/screenshots/MainOmniRoute.png" alt="ओम्नीराउट डॅशबोर्ड" width="820"/>

<br/>
<br/>

# 🚀 ओम्नीराउट — मोफत एआय गेटवे

<img src="./docs/diagrams/readme-hero.svg" width="100%" alt="ओम्नीराउट — कोडिंग कधीही थांबू नका. प्रत्येक एआय टूल → ३५९ प्रदाते — १५०+ मोफत — एका एंडपॉइंटद्वारे. क्लॉड कोड, कोडेक्स, कर्सर, क्लाइन, कोपायलट आणि अँटीग्रॅव्हिटी मोफत क्लॉड / जीपीटी / जेमिनीमध्ये ऑटो-फॉल बॅकसह. RTK + केव्हमॅन स्टॅक्ड कॉम्प्रेशन १५-९५% टोकन वाचवते (~८९% सरासरी) — कधीही मर्यादा गाठू नका. ३५९ एआय प्रदाते · १५०+ मोफत टियर्स · ~१.६२ अब्ज मोफत टोकन/महिना · १९ राउटिंग स्ट्रॅटेजी · $० पासून सुरुवात."/>
...
## 🆓 स्थापित करताच लगेच काम करते — कोणत्याही कीज नाहीत, कोणतेही कॉन्फिग नाही

</div>

<img src="./docs/diagrams/works-zero-config.svg" width="100%" alt="स्थापित करताच लगेच काम करते — शून्य कॉन्फिग. तीन पायऱ्या: 1. स्थापित करा — npm i -g omniroute, सर्व्हर localhost:20128 वर सुरू होतो. 2. तुमचे टूल http://localhost:20128/v1 कडे निर्देशित करा — कोणतेही OpenAI-सुसंगत टूल (Claude Code, Cursor, Cline). 3. ते उत्तर देते — त्वरित उत्तरासाठी auto मॉडेलला कॉल करा, कोणत्याही API कीशिवाय, नोंदणीशिवाय, कॉन्फिगरेशनशिवाय. कीलेस प्रदाता OpenCode Free हे auto कॉम्बोमध्ये आधीच जोडलेले आहे, त्यामुळे नवीन इन्स्टॉल बॉक्समधूनच प्रतिसाद देते."/>

```bash
# नवीन इन्स्टॉल, शून्य क्रेडेन्शियल्स — auto आधीच काम करते:
...
<img src="./docs/diagrams/promise-pillars.svg" width="100%" alt="वचन — एक एंडपॉइंट आणि 359 प्रदाते. दुसरे निरोगी लक्ष्य उपलब्ध असताना स्वयंचलित फॉलबॅक राउटिंग चालू ठेवते. सहा आधारस्तंभ: 359 प्रदात्यांमध्ये लवचिक फॉलबॅक · पात्र वर्कलोडवर 95% पर्यंत टोकन बचत · 150+ मोफत टियर्स आणि 54 आवर्ती/कीलेस कायमस्वरूपी मोफत प्रदात्यांसह सुरू करण्यासाठी $0 · एका कॉन्फिगद्वारे 36 CLI/एजंट इंटिग्रेशन्स · /v1 वर OpenAI, Claude, Gemini आणि Responses API सुसंगतता · सर्किट ब्रेकर्स, TLS स्टील्थ, MCP 110 टूल्स, A2A, मेमरी, गार्डरेल्स, इव्हॅल्स आणि 5,100+ ट्रॅक केलेल्या टेस्ट फाइल्समध्ये 39,000+ स्टॅटिक टेस्ट डिक्लेरेशन्ससह उत्पादन नियंत्रणे."/>
...
<img src="./docs/diagrams/why-pain-fix.svg" width="100%" alt="OmniRoute का — 10 डॅशबोर्ड, निष्क्रिय API कीज आणि अनपेक्षित बिलांची कसरत थांबवा. दहा दैनंदिन समस्या विरुद्ध उपाय: वापरले नसताना कोटा कालबाह्य होणे → सबस्क्रिप्शनचा जास्तीत जास्त वापर करा; कोडिंग करताना रेट लिमिट्स → 4-स्तरीय ऑटो-फॉलबॅक (सबस्क्रिप्शन → API → स्वस्त → मोफत); टूल आउटपुट टोकन वापरणे → RTK + केव्हमन कॉम्प्रेशन (15–95%); महागडे APIs → खर्च-अनुकूलित राउटिंग; प्रत्येक टूलसाठी स्वतःचे सेटअप → एक एंडपॉइंट, एक डॅशबोर्ड; AI ब्लॉक झाले → 3-स्तरीय प्रॉक्सी + TLS स्टील्थ; निष्क्रिय कीज → 3-स्तरीय लवचिकता (सर्किट ब्रेकर्स, की कूलडाउन, मॉडेल लॉकआउट); टीम एक सबस्क्रिप्शन शेअर करत आहे → योग्य-हिस्सा कोटासह की पूल; कोणाच्यातरी क्लाउडद्वारे प्रॉम्प्ट्स → AES-256-GCM एन्क्रिप्टेड कीजसह लोकल-फर्स्ट; खर्चाची दृश्यमानता नाही → थेट विश्लेषण (वापर, कोटा, बचत, p95 लेटन्सी)."/>

<div align="center">

<img src="./docs/diagrams/tier-cascade.svg" width="100%" alt="OmniRoute विनंती प्रवाह: तुमचे IDE किंवा CLI (Claude Code, Cursor, Cline…) एका स्थानिक एंडपॉइंटला (http://localhost:20128/v1) कॉल करते; OmniRoute स्मार्ट राउटर (RTK + केव्हमन कॉम्प्रेशन, 19 राउटिंग स्ट्रॅटेजीज, सर्किट ब्रेकर्स, TLS स्टील्थ, MCP, A2A, गार्डरेल्स) पात्र निरोगी लक्ष्य उपलब्ध असेपर्यंत 4 प्रदाता टियर्समध्ये फॉलबॅक करू शकते — टियर 1 सबस्क्रिप्शन, टियर 2 API की, टियर 3 स्वस्त आणि टियर 4 मोफत."/>
...
## 🏆 OmniRoute ला काय वेगळे बनवते

</div>

<img src="./docs/diagrams/comparison-table.svg" width="100%" alt="OmniRoute ला काय वेगळे बनवते — 9router, OpenRouter, CLIProxyAPI आणि LiteLLM च्या तुलनेत 13 क्षमतांवरील एक जुना वैशिष्ट्य स्नॅपशॉट. OmniRoute: 359 प्रदाते, 150+ इनबिल्ट विनामूल्य टियर, 19 राउटिंग स्ट्रॅटेजी, 12-इंजिन टोकन कॉम्प्रेशन, 110 साधनांसह इनबिल्ट MCP सर्व्हर, A2A एजंट प्रोटोकॉल, परसिस्टंट मेमरी, गार्डरेल्स, क्लाउड एजंट्स, TLS फिंगरप्रिंट स्टील्थ, डेस्कटॉप/टर्मक्स/PWA आणि 42 i18n UI लोकेल्स. OmniRoute MIT-परवानाकृत आणि सेल्फ-होस्टेबल आहे. स्पर्धकांच्या क्षमता आणि संख्या बदलू शकतात; लिंक केलेली कार्यपद्धती पहा."/>

<sub>📊 संपूर्ण कार्यपद्धती आणि 9router, OpenRouter, CLIProxyAPI आणि LiteLLM च्या तुलनेत प्रत्येक वैशिष्ट्याचा तपशील → [`docs/comparison/OMNIROUTE_VS_ALTERNATIVES.md`](docs/comparison/OMNIROUTE_VS_ALTERNATIVES.md)</sub>
