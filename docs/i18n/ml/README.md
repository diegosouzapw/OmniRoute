...
# 🚀 ഓമ്നിറൂട്ട് — സൗജന്യ AI ഗേറ്റ്വേ

<img src="./docs/diagrams/readme-hero.svg" width="100%" alt="ഓമ്നിറൂട്ട് — കോഡിംഗ് ഒരിക്കലും നിർത്തരുത്. എല്ലാ AI ടൂളുകളും → 359 പ്രൊവൈഡർമാർ — 150+ സൗജന്യം — ഒരു എൻഡ്പോയിന്റ് വഴി. ക്ലോഡ് കോഡ്, കോഡെക്സ്, കഴ്സർ, ക്ലൈൻ, കോപൈലറ്റ് & ആൻ്റിഗ്രാവിറ്റി എന്നിവ സൗജന്യ ക്ലോഡ് / GPT / ജെമിനിയിലേക്ക് ഓട്ടോ-ഫാൾബാക്കോടെ. RTK + കേവ്മാൻ സ്റ്റാക്ക്ഡ് കംപ്രഷൻ 15–95% ടോക്കണുകൾ ലാഭിക്കുന്നു (~89% ശരാശരി) — പരിധികൾ ഒരിക്കലും ലംഘിക്കില്ല. 359 AI പ്രൊവൈഡർമാർ · 150+ സൗജന്യ ടയറുകൾ · ~1.62B സൗജന്യ ടോക്കണുകൾ/മാസം · 19 റൂട്ടിംഗ് തന്ത്രങ്ങൾ · തുടങ്ങാൻ $0."/>
...
## 🆓 ഇൻസ്റ്റാൾ ചെയ്യുമ്പോൾ തന്നെ പ്രവർത്തിക്കുന്നു — കീകൾ ഇല്ല, കോൺഫിഗറേഷൻ ഇല്ല

</div>

<img src="./docs/diagrams/works-zero-config.svg" width="100%" alt="ഇൻസ്റ്റാൾ ചെയ്യുമ്പോൾ തന്നെ പ്രവർത്തിക്കുന്നു — സീറോ കോൺഫിഗറേഷൻ. മൂന്ന് ഘട്ടങ്ങൾ: 1. ഇൻസ്റ്റാൾ ചെയ്യുക — npm i -g omniroute, സെർവർ localhost:20128-ൽ ബൂട്ട് ചെയ്യുന്നു. 2. നിങ്ങളുടെ ടൂൾ http://localhost:20128/v1-ലേക്ക് പോയിന്റ് ചെയ്യുക — ഏതെങ്കിലും OpenAI-അനുയോജ്യമായ ടൂൾ (Claude Code, Cursor, Cline). 3. ഇത് മറുപടി നൽകുന്നു — ഒരു തൽക്ഷണ മറുപടിക്കായി മോഡൽ ഓട്ടോയെ വിളിക്കുക, API കീ ഇല്ലാതെ, സൈൻ അപ്പ് ഇല്ലാതെ, കോൺഫിഗറേഷൻ ഇല്ലാതെ. കീലെസ് പ്രൊവൈഡർ OpenCode Free ഓട്ടോ കോംബോയിലേക്ക് മുൻകൂട്ടി വയർ ചെയ്തിരിക്കുന്നു, അതിനാൽ ഒരു പുതിയ ഇൻസ്റ്റാൾ ബോക്സിൽ നിന്ന് തന്നെ പ്രതികരിക്കുന്നു."/>

```bash
# പുതിയ ഇൻസ്റ്റാൾ, സീറോ ക്രെഡൻഷ്യലുകൾ — `auto` ഇതിനകം പ്രവർത്തിക്കുന്നു:
curl http://localhost:20128/v1/chat/completions \
  -H "Content-Type: application/json" \
  -d '{"model":"auto","messages":[{"role":"user","content":"Hello!"}]}'
```

<sub>ഒരു പ്രത്യേക സൗജന്യ ബാക്കെൻഡ് ആണോ ഇഷ്ടപ്പെടുന്നത്? `oc/…` (OpenCode Free) നേരിട്ട് വിളിക്കുക. തുടർന്ന് `auto`-ലേക്ക് അപ്ഗ്രേഡ് ചെയ്യുക, OmniRoute തിരഞ്ഞെടുക്കാൻ അനുവദിക്കുക.</sub>

<sub>📦 **Python, Node.js, PHP, cURL** എന്നിവയ്ക്കായുള്ള ക്വിക്ക്സ്റ്റാർട്ട് സ്ക്രിപ്റ്റുകൾ പകർത്തി ഒട്ടിക്കുക → [`examples/quickstart/`](examples/quickstart/)</sub>
...
<img src="./docs/diagrams/promise-pillars.svg" width="100%" alt="വാഗ്ദാനം — ഒരു എൻഡ്പോയിന്റും 359 പ്രൊവൈഡർമാരും. മറ്റൊരു ആരോഗ്യകരമായ ടാർഗെറ്റ് ലഭ്യമായിരിക്കുമ്പോൾ ഓട്ടോമാറ്റിക് ഫാൾബാക്ക് റൂട്ടിംഗ് നിലനിർത്തുന്നു. ആറ് തൂണുകൾ: 359 പ്രൊവൈഡർമാരിലുടനീളം പ്രതിരോധശേഷിയുള്ള ഫാൾബാക്ക് · യോഗ്യമായ വർക്ക്ലോഡുകളിൽ 95% വരെ ടോക്കൺ ലാഭം · 150+ സൗജന്യ ടയറുകളും 54 ആവർത്തിച്ചുള്ള/കീലെസ് സൗജന്യ-എന്നേക്കും പ്രൊവൈഡർമാരും ഉപയോഗിച്ച് $0-ൽ ആരംഭിക്കുക · ഒരു കോൺഫിഗറേഷനിലൂടെ 36 CLI/ഏജന്റ് സംയോജനങ്ങൾ · OpenAI, Claude, Gemini, Responses API എന്നിവയുമായി /v1-ൽ അനുയോജ്യത · സർക്യൂട്ട് ബ്രേക്കറുകൾ, TLS സ്റ്റെൽത്ത്, MCP 110 ടൂളുകൾ, A2A, മെമ്മറി, ഗാർഡ്റെയിലുകൾ, ഇവാലുകൾ, 5,100+ ട്രാക്ക് ചെയ്ത ടെസ്റ്റ് ഫയലുകളിലായി 39,000+ സ്റ്റാറ്റിക് ടെസ്റ്റ് ഡിക്ലറേഷനുകൾ എന്നിവ ഉൾപ്പെടുന്ന പ്രൊഡക്ഷൻ നിയന്ത്രണങ്ങൾ."/>
...
<img src="./docs/diagrams/why-pain-fix.svg" width="100%" alt="എന്തുകൊണ്ട് OmniRoute — 10 ഡാഷ്ബോർഡുകൾ, ഡെഡ് API കീകൾ, അപ്രതീക്ഷിത ബില്ലുകൾ എന്നിവ കൈകാര്യം ചെയ്യുന്നത് നിർത്തുക. പത്ത് ദൈനംദിന പ്രശ്നങ്ങളും പരിഹാരങ്ങളും: ഉപയോഗിക്കാത്ത ക്വാട്ട കാലഹരണപ്പെടുന്നു → സബ്സ്ക്രിപ്ഷനുകൾ പരമാവധിയാക്കുക; കോഡിംഗിനിടെയുള്ള റേറ്റ് ലിമിറ്റുകൾ → 4-ടയർ ഓട്ടോ-ഫാൾബാക്ക് (സബ്സ്ക്രിപ്ഷൻ → API → വിലകുറഞ്ഞത് → സൗജന്യം); ടൂൾ ഔട്ട്പുട്ടുകൾ ടോക്കണുകൾ കത്തിക്കുന്നു → RTK + കേവ്മാൻ കംപ്രഷൻ (15–95%); വിലകൂടിയ API-കൾ → ചെലവ്-ഒപ്റ്റിമൈസ് ചെയ്ത റൂട്ടിംഗ്; ഓരോ ടൂളിനും അതിൻ്റേതായ സജ്ജീകരണം → ഒരു എൻഡ്പോയിന്റ്, ഒരു ഡാഷ്ബോർഡ്; AI തടഞ്ഞു → 3-ലെവൽ പ്രോക്സി + TLS സ്റ്റെൽത്ത്; ഡെഡ് കീകൾ → 3-ലെയർ റെസിലിയൻസ് (സർക്യൂട്ട് ബ്രേക്കറുകൾ, കീ കൂൾഡൗൺ, മോഡൽ ലോക്കൗട്ട്); ഒരു സബ്സ്ക്രിപ്ഷൻ പങ്കിടുന്ന ടീം → ന്യായമായ പങ്കാളിത്ത ക്വാട്ടകളുള്ള കീ പൂളുകൾ; മറ്റൊരാളുടെ ക്ലൗഡിലൂടെയുള്ള പ്രോംപ്റ്റുകൾ → AES-256-GCM എൻക്രിപ്റ്റ് ചെയ്ത കീകൾ ഉപയോഗിച്ച് ലോക്കൽ-ഫസ്റ്റ്; ചെലവ് ദൃശ്യപരതയില്ല → തത്സമയ അനലിറ്റിക്സ് (ഉപയോഗം, ക്വാട്ട, ലാഭം, p95 ലേറ്റൻസി)."/>

<div align="center">

<img src="./docs/diagrams/tier-cascade.svg" width="100%" alt="OmniRoute അഭ്യർത്ഥന പ്രവാഹം: നിങ്ങളുടെ IDE അല്ലെങ്കിൽ CLI (Claude Code, Cursor, Cline…) ഒരു ലോക്കൽ എൻഡ്പോയിന്റ് വിളിക്കുന്നു (http://localhost:20128/v1); OmniRoute സ്മാർട്ട് റൂട്ടറിന് (RTK + കേവ്മാൻ കംപ്രഷൻ, 19 റൂട്ടിംഗ് തന്ത്രങ്ങൾ, സർക്യൂട്ട് ബ്രേക്കറുകൾ, TLS സ്റ്റെൽത്ത്, MCP, A2A, ഗാർഡ്റെയിലുകൾ) ഒരു യോഗ്യമായ ആരോഗ്യകരമായ ടാർഗെറ്റ് നിലനിൽക്കുമ്പോൾ 4 പ്രൊവൈഡർ ടയറുകളിലുടനീളം ഫാൾബാക്ക് ചെയ്യാൻ കഴിയും — ടയർ 1 സബ്സ്ക്രിപ്ഷൻ, ടയർ 2 API കീ, ടയർ 3 വിലകുറഞ്ഞത്, ടയർ 4 സൗജന്യം."/>
...
<img src="./docs/diagrams/comparison-table.svg" width="100%" alt="OmniRoute-നെ വേറിട്ടു നിർത്തുന്നത് എന്താണ് — 9router, OpenRouter, CLIProxyAPI, LiteLLM എന്നിവയുമായി താരതമ്യം ചെയ്യുമ്പോൾ 13 കഴിവുകളിലുടനീളമുള്ള ഒരു കാലഹരണപ്പെട്ട ഫീച്ചർ സ്നാപ്പ്ഷോട്ട്. OmniRoute: 359 പ്രൊവൈഡർമാർ, 150+ സൗജന്യ ടയറുകൾ ഉൾപ്പെടുത്തിയിരിക്കുന്നു, 19 റൂട്ടിംഗ് തന്ത്രങ്ങൾ, 12-എഞ്ചിൻ ടോക്കൺ കംപ്രഷൻ, 110 ടൂളുകളുള്ള ബിൽറ്റ്-ഇൻ MCP സെർവർ, A2A ഏജന്റ് പ്രോട്ടോക്കോൾ, സ്ഥിരമായ മെമ്മറി, ഗാർഡ്റെയിലുകൾ, ക്ലൗഡ് ഏജന്റുകൾ, TLS ഫിംഗർപ്രിന്റ് സ്റ്റെൽത്ത്, ഡെസ്ക്ടോപ്പ്/ടെർമക്സ്/PWA, 42 i18n UI ലോക്കലുകൾ. OmniRoute MIT ലൈസൻസുള്ളതും സ്വയം ഹോസ്റ്റ് ചെയ്യാവുന്നതുമാണ്. മത്സരാധിഷ്ഠിത കഴിവുകളും എണ്ണങ്ങളും മാറിയേക്കാം; ലിങ്ക് ചെയ്ത രീതിശാസ്ത്രം കാണുക."/>

<sub>📊 9router, OpenRouter, CLIProxyAPI &amp; LiteLLM എന്നിവയുമായി താരതമ്യം ചെയ്യുമ്പോൾ പൂർണ്ണമായ രീതിശാസ്ത്രവും ഓരോ ഫീച്ചറിന്റെയും വിശദാംശങ്ങളും → [`docs/comparison/OMNIROUTE_VS_ALTERNATIVES.md`](docs/comparison/OMNIROUTE_VS_ALTERNATIVES.md)</sub>
