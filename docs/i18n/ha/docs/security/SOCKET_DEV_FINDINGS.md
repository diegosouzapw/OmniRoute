...
## §1 — Shigar da tushen CA na MITM (`77484.js`)
...
| OS                     | Umurni                                                                                                            |
| ---------------------- | ----------------------------------------------------------------------------------------------------------------- |
| Windows                | `certutil -addstore Root <cert>` ta hanyar UAC                                                                    |
...
## §2 — Shigo da bayanan shaida na Zed (`app/api/providers/zed/import/route.js`)

**Fayilolin tushe**:

- `src/app/api/providers/zed/discover/route.ts` _(sabo a v3.8.6)_
...
## §4 / §6 — Mai kula da service na 9router (`api/services/9router/{start,restart}/route.js`)

**Fayilolin tushe**:

- `src/app/api/services/9router/_lib.ts` — factory na supervisor.
