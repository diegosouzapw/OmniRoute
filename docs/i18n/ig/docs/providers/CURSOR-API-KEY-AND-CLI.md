...
Ndebanye aha: `open-sse/config/providers/registry/cursor/index.ts`
(`cursor_apiProvider`, `authType: "apikey"`, otu `format`, `baseUrl` na
`models` dịka `cursor`). Kaadị katalọgụ:
`src/shared/constants/providers/apikey/specialty-media.ts`. Maapụ executor:
