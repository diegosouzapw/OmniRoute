...
<img src="./docs/diagrams/readme-hero.svg" width="100%" alt="OmniRoute — Stop aldrig med at kode. Hvert AI-værktøj → 359 udbydere — 150+ gratis — gennem ét endpoint. Claude Code, Codex, Cursor, Cline, Copilot & Antigravity ind i GRATIS Claude / GPT / Gemini med auto-fallback. RTK + Caveman stablet komprimering sparer 15–95% tokens (~89% gns.) — ram aldrig grænser. 359 AI-udbydere · 150+ gratis niveauer · ~1.62B gratis tokens/måned · 19 routingstrategier · $0 at starte."/>
...
<sub>Foretrækker du en specifik gratis backend? Kald `oc/…` (OpenCode Free) direkte. Gå derefter videre til `auto` og lad OmniRoute vælge.</sub>

<sub>📦 Kopier-indsæt quickstart-scripts til **Python, Node.js, PHP og cURL** → [`examples/quickstart/`](examples/quickstart/)</sub>
...
<img src="./docs/diagrams/why-pain-fix.svg" width="100%" alt="Hvorfor OmniRoute — stop med at jonglere med 10 dashboards, døde API-nøgler og overraskende regninger. Ti daglige smerter vs. løsninger: kvote udløber ubrugt → maksimer abonnementer; ratebegrænsninger midt i kodning → 4-lags auto-fallback (Abonnement → API → Billig → Gratis); værktøjsoutput brænder tokens → RTK + Caveman-komprimering (15–95%); dyre API'er → omkostningsoptimeret routing; hvert værktøj sin egen opsætning → ét endepunkt, ét dashboard; AI blokeret → 3-niveau proxy + TLS stealth; døde nøgler → 3-lags modstandsdygtighed (afbrydere, nøgle-nedkøling, model-lockout); team deler ét abonnement → nøglepuljer med fair-share kvoter; prompts gennem nogens sky → local-first med AES-256-GCM krypterede nøgler; ingen forbrugssynlighed → live-analyse (forbrug, kvote, besparelser, p95-latency)."/>

<div align="center">

<img src="./docs/diagrams/tier-cascade.svg" width="100%" alt="OmniRoute anmodningsflow: din IDE eller CLI (Claude Code, Cursor, Cline…) kalder ét lokalt endepunkt (http://localhost:20128/v1); OmniRoute Smart Router (RTK + Caveman-komprimering, 19 routingstrategier, afbrydere, TLS stealth, MCP, A2A, guardrails) kan falde tilbage på tværs af 4 udbyderniveauer, så længe et kvalificeret sundt mål forbliver — Niveau 1 Abonnement, Niveau 2 API-nøgle, Niveau 3 Billig og Niveau 4 Gratis."/>
...
<img src="./docs/diagrams/comparison-table.svg" width="100%" alt="Hvad adskiller OmniRoute – et forældet feature-snapshot vs 9router, OpenRouter, CLIProxyAPI og LiteLLM på tværs af 13 funktioner. OmniRoute: 359 udbydere, 150+ indbyggede gratis niveauer, 19 routingstrategier, 12-motorers token-komprimering, indbygget MCP-server med 110 værktøjer, A2A agentprotokol, vedvarende hukommelse, guardrails, cloud-agenter, TLS-fingeraftryks-stealth, Desktop/Termux/PWA og 42 i18n UI-lokaliteter. OmniRoute er MIT-licenseret og kan selv-hostes. Konkurrentfunktioner og -antal kan ændre sig; se den linkede metodologi."/>

<sub>📊 Fuld metodologi &amp; detaljer pr. funktion vs 9router, OpenRouter, CLIProxyAPI &amp; LiteLLM → [`docs/comparison/OMNIROUTE_VS_ALTERNATIVES.md`](docs/comparison/OMNIROUTE_VS_ALTERNATIVES.md)</sub>
