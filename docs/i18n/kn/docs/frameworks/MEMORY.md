...
`src/shared/schemas/memory.ts` ನಲ್ಲಿರುವ `MemorySettingsExtended` ನಲ್ಲಿ ಒಂಬತ್ತು ಎಂಬೆಡಿಂಗ್ ಮತ್ತು ವೆಕ್ಟರ್ ಕ್ಷೇತ್ರಗಳು ಲಭ್ಯವಿದ್ದು, ಅವುಗಳನ್ನು `src/lib/db/settings.ts` ಮೂಲಕ ಶಾಶ್ವತವಾಗಿ ಸಂಗ್ರಹಿಸಲಾಗುತ್ತದೆ:

| ಕ್ಷೇತ್ರ                  | ಪ್ರಕಾರ                                             | ಡೀಫಾಲ್ಟ್ | ವಿವರಣೆ                                                                    |
| ------------------------ | -------------------------------------------------- | -------- | ------------------------------------------------------------------------- |
| `embeddingSource`        | `"remote" \| "static" \| "transformers" \| "auto"` | `"auto"` | ಬಳಸಬೇಕಾದ ಎಂಬೆಡಿಂಗ್ ಮೂಲ                                                    |
| `embeddingProviderModel` | `string \| null`                                   | `null`   | `provider/model` ಸ್ವರೂಪದಲ್ಲಿನ ಪೂರೈಕೆದಾರ/ಮಾದರಿ                             |
| `customBaseUrl`          | `string \| null`                                   | `null`   | ಮೆಮೊರಿಗೆ ಮಾತ್ರ ಅನ್ವಯಿಸುವ OpenAI-ಹೊಂದಾಣಿಕೆಯ ಎಂಡ್ಪಾಯಿಂಟ್ ಮೂಲ URL            |
| `customModelId`          | `string \| null`                                   | `null`   | ಕಸ್ಟಮ್ ಎಂಡ್ಪಾಯಿಂಟ್ಗೆ ಕಳುಹಿಸಲಾದ ಮಾದರಿ ID                                   |
| `transformersEnabled`    | `boolean`                                          | `false`  | Transformers.js ಗೆ ಆಯ್ಕೆಯ ಮೂಲಕ ಸಕ್ರಿಯಗೊಳಿಸುವಿಕೆ (MiniLM, ~400MB)          |
| `staticEnabled`          | `boolean`                                          | `false`  | ಸ್ಥಿರ potion-base-8M ಸ್ಥಳೀಯ ಮಾದರಿಗೆ ಆಯ್ಕೆಯ ಮೂಲಕ ಸಕ್ರಿಯಗೊಳಿಸುವಿಕೆ          |
| `rerankEnabled`          | `boolean`                                          | `false`  | ಮರುಶ್ರೇಯಾಂಕ ಹಂತವನ್ನು ಸಕ್ರಿಯಗೊಳಿಸಿ (ಪ್ರತಿ ವಿನಂತಿಗೆ +200-500ms ಸೇರಿಸುತ್ತದೆ) |
| `rerankProviderModel`    | `string \| null`                                   | `null`   | `provider/model` ಸ್ವರೂಪದಲ್ಲಿನ ಮರುಶ್ರೇಯಾಂಕ ಪೂರೈಕೆದಾರ/ಮಾದರಿ                 |
| `vectorStore`            | `"sqlite-vec" \| "qdrant" \| "auto"`               | `"auto"` | ಬಳಸಬೇಕಾದ ವೆಕ್ಟರ್ ಬ್ಯಾಕೆಂಡ್                                                |

ಇವುಗಳನ್ನು `GET /PUT /api/settings/memory` ಮೂಲಕ ಬಹಿರಂಗಪಡಿಸಲಾಗಿದೆ (`MemorySettingsExtendedSchema` ಸ್ಕೀಮಾ).

`remote` ಮೂಲಕ್ಕಾಗಿ, ಮೆಮೊರಿಯು ಐಚ್ಛಿಕ `customBaseUrl` ಮತ್ತು
`customModelId` ಸೆಟ್ಟಿಂಗ್ಗಳನ್ನೂ ಸ್ವೀಕರಿಸುತ್ತದೆ. ಇವು ಒಟ್ಟಾಗಿ ಜಾಗತಿಕ ಎಂಬೆಡಿಂಗ್ ರಿಜಿಸ್ಟ್ರಿಯನ್ನು ಬದಲಾಯಿಸದೆ OpenAI-ಹೊಂದಾಣಿಕೆಯ `/embeddings`
ಎಂಡ್ಪಾಯಿಂಟ್ ಮತ್ತು ಮಾದರಿಯನ್ನು ಆಯ್ಕೆಮಾಡುತ್ತವೆ. ಬಳಸುವ ಮೊದಲು ಎಂಡ್ಪಾಯಿಂಟ್ ಅನ್ನು
ಸಾಮಾನ್ಯೀಕರಿಸಲಾಗುತ್ತದೆ ಮತ್ತು ಪೂರೈಕೆದಾರರ ಹೊರಹೋಗುವ URL ನೀತಿಯ ಮೂಲಕ ಪರಿಶೀಲಿಸಲಾಗುತ್ತದೆ: HTTP(S)
ಅಗತ್ಯವಿದೆ, ಎಂಬೆಡ್ ಮಾಡಲಾದ ರುಜುವಾತುಗಳು ಮತ್ತು ಕ್ವೆರಿ ಸ್ಟ್ರಿಂಗ್ಗಳನ್ನು ತಿರಸ್ಕರಿಸಲಾಗುತ್ತದೆ ಹಾಗೂ ಕ್ಲೌಡ್-ಮೆಟಾಡೇಟಾ
ವಿಳಾಸಗಳನ್ನು ನಿರ್ಬಂಧಿತವಾಗಿಯೇ ಇರಿಸಲಾಗುತ್ತದೆ. ಖಾಲಿ ಮೌಲ್ಯಗಳು ಆಯ್ಕೆಮಾಡಿದ ರಿಜಿಸ್ಟ್ರಿ ಪೂರೈಕೆದಾರರನ್ನು ಉಳಿಸಿಕೊಳ್ಳುತ್ತವೆ. ಡ್ಯಾಶ್ಬೋರ್ಡ್ಗೆ
ಹಿಂತಿರುಗಿಸುವ ದೋಷಗಳನ್ನು ಸ್ವಚ್ಛಗೊಳಿಸಲಾಗುತ್ತದೆ ಮತ್ತು ಎಂಡ್ಪಾಯಿಂಟ್ ರುಜುವಾತುಗಳನ್ನು ಎಂದಿಗೂ ಲಾಗ್ ಮಾಡಲಾಗುವುದಿಲ್ಲ.

> **TODO (D20):** `global` ವ್ಯಾಪ್ತಿ (ಎಲ್ಲಾ API ಕೀಗಳಾದ್ಯಂತ ಮೆಮೊರಿಗಳನ್ನು ಹಂಚಿಕೊಳ್ಳುವುದು) ಈ ಬಿಡುಗಡೆಯಲ್ಲಿ
> ಅಳವಡಿಸಲಾಗಿಲ್ಲ. ಇದಕ್ಕೆ ಸ್ಕೀಮಾ ಬದಲಾವಣೆಗಳು ಮತ್ತು ಜಾಗತಿಕ ಮರುಪಡೆಯುವಿಕೆ
> ಪಥದ ಅಗತ್ಯವಿದೆ. ಇದನ್ನು ಪ್ರತ್ಯೇಕವಾಗಿ ಟ್ರ್ಯಾಕ್ ಮಾಡಿ.
