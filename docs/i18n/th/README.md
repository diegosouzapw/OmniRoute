...
> การรวมแพ็กเกจฟรีด้วยตนเองเป็นเรื่องยุ่งยาก — มี SDK หลายสิบรายการ ขีดจำกัดอัตราการใช้งานหลายสิบแบบ และคุณไม่รู้เลยว่าจริง ๆ แล้วมีโควตาอยู่เท่าไร OmniRoute รวบรวม **รายการแพ็กเกจฟรี 489 รายการในคีย์พูลแบบต่ออายุ 35 คีย์** และคำนวณจำนวนโทเค็นพาดหัวจาก **17 พูลที่เผยแพร่งบประมาณรายเดือนเป็นค่าบวก พร้อมขีดจำกัด Groq แยกตามโมเดลอีกห้ารายการ** โดยขจัดการนับซ้ำตามพูลที่ใช้ร่วมกัน โควตาที่เปิดให้ใช้ได้เฉพาะหลังการตรวจสอบตัวตนตามภูมิภาค (ปัจจุบันคือ ModelScope) จะแสดงแยกต่างหาก โดยมีอีก +~6M ที่ต้องผ่านการยืนยันตัวตนตามภูมิภาค และจะไม่นำมารวมในจำนวนพาดหัว ผลลัพธ์ยังคงแสดงอยู่บนแดชบอร์ด (`/dashboard/free-tiers`)

<img src="./docs/diagrams/free-tier-budget.svg" width="100%" alt="การ์ดงบประมาณแพ็กเกจฟรีของ OmniRoute: โทเค็นฟรีคงที่ประมาณ ~1.62B ต่อเดือน และสูงสุดประมาณ ~2.22B ในเดือนแรกเมื่อรวมเครดิตสมัครใช้งาน จากคีย์พูลแบบต่ออายุที่มีเอกสารกำกับ 35 คีย์ ครอบคลุมรายการแพ็กเกจฟรีที่จัดหมวดหมู่ไว้ 489 รายการภายใต้เอนด์พอยต์เดียว การคำนวณอย่างโปร่งใสโดยขจัดพูลที่ซ้ำกัน — แต่ละพูลที่ใช้ร่วมกันจะถูกนับเพียงครั้งเดียว รวมถึงพูลแบบต่ออายุ 17 พูลที่เผยแพร่งบประมาณโทเค็นรายเดือนเป็นค่าบวก พร้อมขีดจำกัด Groq แยกตามโมเดลอีกห้ารายการ; ผู้ให้บริการ 13 รายถูกทำเครื่องหมายว่าควรหลีกเลี่ยงในแค็ตตาล็อกความเสี่ยงด้านข้อกำหนด เพื่อให้คุณเป็นผู้ตัดสินใจ แถบงบประมาณประกอบด้วย Mistral 1B, Nara 210M, LLM7 150M, xKiro 150M, Groq 30M (ขีดจำกัดแยกตามโมเดลห้ารายการ) และพูลขนาดเล็กอื่น ๆ รวมถึงเครดิตสมัครใช้งานสำหรับเดือนแรกและผู้ให้บริการที่ฟรีถาวรโดยไม่มีขีดจำกัดโทเค็น ซึ่งจะแสดงแยกต่างหากเพื่อไม่ให้จำนวนพาดหัวสูงเกินจริง ดูปริมาณที่ใช้ไป/คงเหลือแบบสดได้ที่ /dashboard/free-tiers."/>

> สรุปแบบเคลื่อนไหวของหน้า `/dashboard/free-tiers` แบบสด ดูระเบียบวิธีฉบับเต็ม (การขจัดพูลซ้ำ ระดับเครดิต ข้อกำหนดของผู้ให้บริการ): **[docs/reference/FREE_TIERS.md](docs/reference/FREE_TIERS.md)**.
>
> <sub>ตัวเลขเหล่านี้ได้รับการตรวจสอบซ้ำทุกสองสัปดาห์เทียบกับแค็ตตาล็อกสด และ **สามารถเปลี่ยนแปลงได้ทั้งเพิ่มขึ้นและลดลง** — เมื่อผู้ให้บริการยุติแพ็กเกจฟรี ตัวเลขก็จะลดลง; เมื่อมีรายใหม่เพิ่มเข้ามา ตัวเลขก็จะสูงขึ้น เราเผยแพร่ค่าที่แค็ตตาล็อกคำนวณได้จริง ไม่ใช่กรณีดีที่สุดที่ปัดตัวเลขขึ้น</sub>
...
**👋 ติดตามผู้ดูแล — รับข่าวสารผู้ให้บริการรายใหม่ รุ่นใหม่ และเคล็ดลับก่อนใคร:**
...
<div align="center">
<b>＋ ใช้งานร่วมกับเครื่องมือเหล่านี้ได้ด้วย</b> · Agent Deck · Kiro · Command Code · Antigravity · Windsurf · AMP · <b>เครื่องมือใดๆ ที่เข้ากันได้กับ OpenAI</b>
</div>
...
**เปิดใช้ CLI ที่รองรับผ่าน OmniRoute ได้ด้วยคำสั่งเดียว** — ไม่มีการเขียนไฟล์การกำหนดค่า
ข้อมูลประจำตัวจะถูกแทรกแยกในแต่ละโปรเซส และ Qwen/Gemini จะใช้โฮมแบบแยกอิสระชั่วคราว:
...
omniroute configure codex          # รองรับเช่นกัน: claude opencode qwen aider goose gemini cline continue kilo
```

ทุกคำสั่งจะใช้บริบทรีโมตที่เปิดใช้งานอยู่ (`omniroute connect <host>`), `--dry-run`
...
> **ผู้ให้บริการที่ลงทะเบียนแล้ว 357 ราย** ครอบคลุมคอลเลกชันมาตรฐานสำหรับแชต สื่อ การค้นหา ระบบภายใน เครื่องมือเอเจนต์บนคลาวด์ และระบบ โดยมี **152 รายที่มาพร้อมข้อมูลเมตาสำหรับการค้นพบ `hasFree: true`** รีจิสทรีโมเดลแชตครอบคลุม **ผู้ให้บริการ 229 ราย / คู่ผู้ให้บริการ-โมเดลที่ไม่ซ้ำกัน 2,554 คู่ / ID โมเดลดิบ 1,283 รายการ** ส่วนแค็ตตาล็อกงบประมาณแบบใช้ฟรีที่แยกต่างหากมี **ข้อมูลรายโมเดล 491 แถว** **พูลแบบต่ออายุ 35 พูล** และ **ผู้ให้บริการที่ใช้งานฟรีตลอดไปแบบต่ออายุ/ไม่ต้องใช้คีย์ 54 ราย** ตัวเลขเหล่านี้ใช้ฐานในการคำนวณที่แตกต่างกันโดยเจตนา สามารถดูคำจำกัดความและการคำนวณแบบตัดพูลที่ซ้ำกันได้ใน [เอกสารอ้างอิงผู้ให้บริการ](docs/reference/PROVIDER_REFERENCE.md) และ [ระดับการใช้งานฟรี](docs/reference/FREE_TIERS.md)
...
<sub>…และอีกกว่า 330 ราย — ไอคอนทั้งหมดโหลดแบบสดจากแค็ตตาล็อกผู้ให้บริการของแดชบอร์ด 📖 [เอกสารอ้างอิงผู้ให้บริการ](docs/reference/PROVIDER_REFERENCE.md)</sub>
...
<table>
  ...
  <tr>
    ...
    <td align="center" width="150"><img src="./public/openference.svg" width="42" alt="Openference"/><br/><b>Openference</b><br/><sub>Qwen3.8 27B, Llama 3.2<br/>แพ็กเกจฟรี</sub></td>
...
📖 แคตตาล็อกฉบับเต็มที่เครื่องอ่านได้ → [`docs/reference/PROVIDER_REFERENCE.md`](docs/reference/PROVIDER_REFERENCE.md)
...
<table>
  ...
  <tr><td nowrap><b>ภาษา</b></td><td>TypeScript 6.0 — <b>TypeScript 100%</b> ครอบคลุมทั้ง <code>src/</code> และ <code>open-sse/</code> (ไม่มี <code>any</code> ในแกนหลักตั้งแต่ v2.0)</td></tr>
  <tr><td nowrap><b>เฟรมเวิร์ก</b></td><td>Next.js 16 + React 19 + Tailwind CSS 4</td></tr>
  <tr><td nowrap><b>ฐานข้อมูล</b></td><td>better-sqlite3 (SQLite, การบันทึกแบบ WAL) + LowDB (JSON แบบเดิม) — โมดูลโดเมน 122 รายการ, การย้ายข้อมูล 178 รายการ</td></tr>
  <tr><td nowrap><b>หน่วยความจำ</b></td><td>การค้นหาข้อความแบบเต็มด้วย SQLite FTS5 + เวกเตอร์เอ็มเบดดิงที่ควอนไทซ์เป็น int8, การเสื่อมค่าตามชนิด</td></tr>
  ...
  <tr><td nowrap><b>การยืนยันตัวตนและความปลอดภัย</b></td><td>OAuth 2.0 (PKCE) + JWT + คีย์ API + การยืนยันตัวตนแบบกำหนดขอบเขตของ MCP · AES-256-GCM สำหรับข้อมูลขณะจัดเก็บ · DOMPurify</td></tr>
  <tr><td nowrap><b>การพรางตัว</b></td><td>wreq-js — การเลียนแบบลายนิ้วมือ TLS แบบ JA3 / JA4, พร็อกซี 3 ระดับ</td></tr>
  <tr><td nowrap><b>ความทนทาน</b></td><td>เซอร์กิตเบรกเกอร์, การหน่วงเวลาแบบเอ็กซ์โพเนนเชียล, การป้องกันคำขอถาโถมพร้อมกัน, การกู้คืนอัตโนมัติด้วย auto-combo</td></tr>
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/guides/CLAUDE-CODE-CONFIGURATION.md">การกำหนดค่า Claude Code</a></b></td><td>เชื่อม Claude Code เข้ากับ OmniRoute (ภายในเครื่อง/ระยะไกล) ด้วย <code>launch</code> + โปรไฟล์เฉพาะแต่ละโมเดล</td></tr>
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/guides/UNINSTALL.md">คู่มือการถอนการติดตั้ง</a></b></td><td>การลบอย่างหมดจดสำหรับทุกวิธีการติดตั้ง</td></tr>
  <tr><td nowrap><b><a href="docs/reference/ENVIRONMENT.md">การกำหนดค่าสภาพแวดล้อม</a></b></td><td>ตัวแปรและข้อมูลอ้างอิง <code>.env</code> ทั้งหมด</td></tr>
</table>
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/compression/COMPRESSION_ENGINES.md">เอนจินการบีบอัด</a></b></td><td>Caveman, RTK, ไปป์ไลน์แบบซ้อน และส่วนเชื่อมต่อ dashboard/API/MCP</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/compression/COMPRESSION_LANGUAGE_PACKS.md">แพ็กภาษาสำหรับการบีบอัด</a></b></td><td>การตรวจหาภาษาและการสร้างชุดกฎ Caveman</td></tr>
  <tr><td nowrap><b><a href="docs/architecture/RESILIENCE_GUIDE.md">คู่มือความยืดหยุ่นของระบบ</a></b></td><td>วงจรตัดการทำงาน ช่วงพัก คิว การป้องกัน thundering herd และการปลอมแปลง TLS</td></tr>
  <tr><td nowrap><b><a href="docs/routing/AUTO-COMBO.md">เอนจิน Auto-Combo</a></b></td><td>การให้คะแนนด้วย 16 ปัจจัย แพ็กโหมด และการฟื้นฟูตัวเอง</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/guides/FEATURES.md">แกลเลอรีคุณสมบัติ</a></b></td><td>แนะนำแดชบอร์ดด้วยภาพพร้อมภาพหน้าจอ</td></tr>
  <tr><td nowrap><b><a href="docs/architecture/CODEBASE_DOCUMENTATION.md">เอกสารประกอบโค้ดเบส</a></b></td><td>แนะนำโค้ดเบสแบบเป็นมิตรสำหรับผู้เริ่มต้น</td></tr>
</table>
...
<table>
  <tr><th align="left">เอกสาร</th><th align="left">คำอธิบาย</th></tr>
  <tr><td nowrap><b><a href="docs/reference/API_REFERENCE.md">ข้อมูลอ้างอิง API</a></b></td><td>เอนด์พอยต์ทั้งหมดพร้อมตัวอย่าง</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/frameworks/MCP-SERVER.md">คู่มือเซิร์ฟเวอร์ MCP</a></b></td><td>การติดตั้ง MCP วิธีการรับส่งข้อมูล และข้อมูลอ้างอิงเครื่องมือ</td></tr>
...
<table>
  ...
  <tr><td nowrap><b><a href="CHANGELOG.md">บันทึกการเปลี่ยนแปลง</a></b></td><td>ประวัติการเผยแพร่ทั้งหมดแยกตามเวอร์ชัน</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/ops/COVERAGE_PLAN.md">แผนความครอบคลุม</a></b></td><td>กลยุทธ์ความครอบคลุมของการทดสอบสำหรับประกาศการทดสอบแบบสแตติกมากกว่า 39,000 รายการ ในไฟล์ทดสอบที่ติดตามมากกว่า 5,100 ไฟล์</td></tr>
</table>
...
> OmniRoute ได้รับการหล่อหลอมโดยชุมชนโอเพนซอร์สที่เปี่ยมด้วยความมุ่งมั่น บุคคลเหล่านี้ได้สร้างผลงานอันโดดเด่นซึ่งส่งผลโดยตรงต่อคุณภาพ ความเสถียร และการเข้าถึงของโปรเจกต์ **ขอบคุณ**

### ผู้มีส่วนร่วมภายนอก จัดอันดับตามจำนวน pull request ที่ผสานแล้ว
...
<sub>ข้อมูลถูกตรึง ณ ปลายทางล่าสุดของ <code>release/v3.8.50</code> ที่ <code>dafb4ae808</code> โดยรวมการผสานจนถึง 2026-08-24 05:26:03 UTC การสำรวจสำมะโนผ่าน GitHub GraphQL แบบแบ่งหน้าพบ PR ที่ผสานแล้ว 5,911 รายการ: 2,707 รายการโดยเจ้าของ repository, 179 รายการโดย Dependabot และ <b>PR ภายนอก 3,025 รายการจากผู้มีส่วนร่วมที่ไม่ซ้ำกัน 535 คน</b> “บรรทัดที่เปลี่ยนแปลง” คือจำนวนบรรทัดที่เพิ่มและลบตามข้อมูลของ GitHub ซึ่งรวมถึงไฟล์ที่สร้างขึ้นโดยอัตโนมัติ, lockfile, แค็ตตาล็อก, คำแปล และเอกสารประกอบ ตัวเลขนี้สะท้อนปริมาณการเปลี่ยนแปลง ไม่ใช่จำนวนบรรทัดโค้ดที่เขียนขึ้นเอง โดยยังคงรวมผู้ที่มีอันดับเสมอกัน ณ จุดตัด</sub>

### คอมมิตที่ระบุแหล่งที่มาบน GitHub
...
<table>
  <tr>
    ...
    <td align="center" width="160">
      ...
      <sub>🏅 69 คอมมิตที่ระบุแหล่งที่มาจาก GitHub · อันดับ #6 ร่วม</sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="160">
    ...
    <td align="center" width="160">
      ...
      <sub>🏅 51 คอมมิตที่ระบุแหล่งที่มาจาก GitHub · อันดับ #10 ร่วม</sub>
    </td>
    <td align="center" width="160">
...
<sub>ตรวจสอบอีกครั้งเมื่อ 2026-08-24 06:14:31 UTC: คอมมิตที่ระบุแหล่งที่มาจาก GitHub ซึ่งรายงานโดย Contributors API ของรีโพซิทอรีสำหรับสาขาเริ่มต้น <code>release/v3.8.50</code> โดย API ส่งคืนข้อมูลระบุตัวตน 525 รายการ (ผู้ใช้ 415 รายการ บอต 2 รายการ และผู้ไม่เปิดเผยตัวตน 108 รายการ) ตารางนี้ไม่รวมผู้ดูแล บอต และข้อมูลระบุตัวตนแบบไม่เปิดเผยตัวตน และยังคงอันดับร่วมไว้ ตารางนี้แยกต่างหากจากทั้งการจัดอันดับ PR ที่ผสานแล้วข้างต้น และการสำรวจสำมะโนจากข้อมูลเมตาของ Git จำนวน 639 คนด้านล่าง</sub>

> 🙏 ฟีเจอร์ การแก้ไขข้อบกพร่อง และการปรับปรุงโครงสร้างพื้นฐานจากผู้มีส่วนร่วมเหล่านี้เป็น **ส่วนสำคัญ** ที่ทำให้ OmniRoute เชื่อถือได้และเปี่ยมด้วยฟีเจอร์ ทุก pull request ทุกกรณีทดสอบ และทุกไฟล์แปล i18n ล้วนมีความสำคัญ โอเพนซอร์สสร้างขึ้นโดยผู้คนเช่นพวกเขา
