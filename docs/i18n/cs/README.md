...
| ⚠️ **Node.js Runtime Warning**     | Login page proactively detects incompatible Node.js versions and shows a clear warning banner                                                     |
...
- **Runtime**: Node.js 22.22.2+ or 24.x LTS (24 LTS recommended)
