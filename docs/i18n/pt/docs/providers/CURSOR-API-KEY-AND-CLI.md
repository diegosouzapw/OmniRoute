...
Registo: `open-sse/config/providers/registry/cursor/index.ts`
(`cursor_apiProvider`, `authType: "apikey"`, os mesmos `format`, `baseUrl` e
`models` que `cursor`). Cartão do catálogo:
