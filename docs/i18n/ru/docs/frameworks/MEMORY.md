...
> **TODO (D20):** Область действия `global` (совместное использование воспоминаний всеми ключами API) в этом выпуске
> не реализована. Для неё требуются изменения схемы и глобальный путь извлечения.
