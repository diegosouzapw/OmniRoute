...
| `MODEL_CATALOG_INCLUDE_NAMES`             | `true`             | `src/app/api/v1/models/catalog.ts`                                    | Include display-friendly `name` fields in `/v1/models` responses. Disable for clients that expect IDs only. |
