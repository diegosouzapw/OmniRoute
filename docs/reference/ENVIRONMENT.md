...
| `PROVIDER_LIMITS_SYNC_INTERVAL_MINUTES`         | `70`                                                | `src/shared/services/providerLimitsSyncScheduler.ts`        | Provider rate-limit and quota polling interval.                                                                                                                        |
...
| `OMNIROUTE_REASONING_CACHE_CLEANUP_INTERVAL_MS` | `1800000`                                           | `open-sse/services/reasoningCache.ts`                       | Reasoning cache cleanup cadence (ms). Floor `60000`.                                                                                                                   |
...
| `OMNIROUTE_REDIS_CONTAINER_NAME`            | `omniroute-redis`                                                           | `bin/cli/commands/redis.mjs`                                              | Container name for the 1-click Redis launcher (`omniroute redis up`). Used by the CLI and local Redis API.                                                                                                                                                                                                                                                            |
