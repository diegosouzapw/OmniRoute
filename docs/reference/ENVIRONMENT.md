...
| `OMNIROUTE_CC_REDACT_THINKING`                              | `false`                      | `open-sse/services/claudeCodeCompatible.ts` | Opt-in: add `redact-thinking-2026-02-12` to Claude Code-compatible `anthropic-beta` headers. Leave unset for OpenAI-compatible clients that need visible `reasoning_content` streaming.                                                                    |
