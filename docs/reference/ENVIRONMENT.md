...
| `SUBSTRATE_BIN`                                  | `cargo run -q -p driver-cli --`                     | `src/lib/a2a/skills/agentDispatch.ts`                       | Optional local Substrate driver binary path for the agent-dispatch A2A skill.                                                                                           |
| `SUBSTRATE_HTTP_URL`                             | _(unset)_                                           | `open-sse/mcp-server/tools/dispatchTools.ts`                | Optional Substrate control-plane HTTP endpoint used by MCP dispatch tools.                                                                                              |
...
| `AUGGIE_BIN`                     | PATH lookup                                   | Absolute path override for the Auggie CLI binary used by `open-sse/executors/auggie.ts`.         |
| `CLI_AUGGIE_BIN`                 | PATH lookup                                   | Alias for `AUGGIE_BIN`; `AUGGIE_BIN` takes precedence when both are set.                         |
...
| `PROXY_HEALTH_ENABLED`                          | `true`                  | `src/lib/proxyHealth/scheduler.ts`                                                      | Enables the periodic proxy-registry health sweep. Set to `false` to disable the scheduler.                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `PROXY_HEALTH_INTERVAL_MS`                      | `600000`                | `src/lib/proxyHealth/scheduler.ts`                                                      | Sweep interval for proxy-registry health checks. Values below `60000` ms fall back to the default.                                                                                                                                                                                                                                                                                                                                                                                                           |
| `PROXY_AUTO_REMOVE`                             | `false`                 | `src/lib/proxyHealth/scheduler.ts`                                                      | Auto-remove proxies after repeated scheduler healthcheck failures.                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `PROXY_AUTO_REMOVE_AFTER`                       | `3`                     | `src/lib/proxyHealth/scheduler.ts`                                                      | Consecutive scheduler failures required before auto-removal when `PROXY_AUTO_REMOVE=true`.                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| `BIFROST_KILLSWITCH_DISABLED`               | _(unset)_                                                                   | `open-sse/executors/bifrost.ts`                                           | Disables the Bifrost provider kill switch for controlled incident diagnosis. Leave unset/false in normal operation.                                                                                                                                                                                                                                                   |
| `BIFROST_SHADOW_ENABLED`                    | `false`                                                                     | `open-sse/executors/bifrostShadow.ts`                                     | Enables Bifrost shadow traffic comparison while keeping the TypeScript execution path authoritative.                                                                                                                                                                                                                                                                  |
| `BIFROST_SHADOW_SAMPLE_RATE`                | `0.05`                                                                      | `open-sse/executors/bifrostShadow.ts`                                     | Fraction of eligible requests sampled for Bifrost shadow execution, from `0.0` to `1.0`.                                                                                                                                                                                                                                                                              |
| `BIFROST_SHADOW_COST_OR_LATENCY_WINS`       | `false`                                                                     | `open-sse/executors/bifrostShadow.ts`                                     | Counts cost or latency improvements from shadow traffic as candidate wins when evaluating migration readiness.                                                                                                                                                                                                                                                        |
...
| `OTEL_EXPORTER_OTLP_ENDPOINT`               | _(unset)_                                                                   | `instrumentation-node.ts`, `open-sse/observability/otelExporter.ts`       | OTLP HTTP endpoint for exporting OpenTelemetry traces. When unset, tracing stays disabled.                                                                                                                                                                                                                                                                            |
| `OTEL_SERVICE_NAME`                         | `omniroute`                                                                 | `instrumentation-node.ts`                                                 | Service name attached to exported OpenTelemetry spans.                                                                                                                                                                                                                                                                                                               |
| `OTEL_SDK_DISABLED`                         | `false`                                                                     | `instrumentation-node.ts`, `open-sse/observability/otelExporter.ts`       | Standard OpenTelemetry switch that disables SDK initialization when set to `true`.                                                                                                                                                                                                                                                                                    |
