...
| `SITE_PUBLIC_URL`                       | `http://localhost:20128`                                        | `site/lib/portalSession.ts`, `site/app/api` | Public site origin used by the SaaS portal and checkout flows.                                                                                                                                                                                                                                    |
| `PUBLIC_SITE_URL`                       | `http://localhost:20128`                                        | `src/app/api/saas/checkout/start/route.ts`  | Legacy/public alias for the same site origin used by some site routes and builds.                                                                                                                                                                                                                 |
| `NEXT_PUBLIC_SITE_URL`                  | `http://localhost:20128`                                        | `site/app`, `src/app/api/saas/checkout`     | Client-visible site origin for portal links and checkout flows. Must match the public deployment URL.                                                                                                                                                                                             |
| `OMNIROUTE_API_URL`                     | `http://localhost:20128`                                        | `site/lib/omniroute.ts`, `site/app/api`     | Internal API base used by the site layer when talking to OmniRoute.                                                                                                                                                                                                                               |
| `OMNIROUTE_DEMO_API_KEY`                | _(unset)_                                                       | `site/lib/omniroute.ts`                     | Demo API key used by the site demo/login flow.                                                                                                                                                                                                                                                    |
| `SITE_PORTAL_SECRET`                    | _(unset)_                                                       | `site/lib/portalSession.ts`, `src/lib/site` | Shared secret used to sign and validate portal sessions in the site layer.                                                                                                                                                                                                                        |
...
| `MERCADO_PAGO_ACCESS_TOKEN` | Mercado Pago | Access token for the site checkout/payment flows. |
| `MERCADO_PAGO_PUBLIC_KEY`   | Mercado Pago | Public key for the site checkout/payment flows.   |
| `MP_ACCESS_TOKEN`           | Mercado Pago | Legacy alias for `MERCADO_PAGO_ACCESS_TOKEN`.     |
| `MP_PUBLIC_KEY`             | Mercado Pago | Legacy alias for `MERCADO_PAGO_PUBLIC_KEY`.       |
