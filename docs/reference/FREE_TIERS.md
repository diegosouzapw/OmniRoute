...
| **+ first month with signup credits**       | **~2.08B**        | Steady + one-time signup credits (Z.AI 20M, DeepSeek 5M, …), deduped per account. **First month only** — does not recur.                                                                                                                                                           |
...
**Honest headline:** _OmniRoute aggregates **~1.47B documented free tokens per month** (up to ~2.08B in your first month with signup credits) across 34 free-tier pools — plus a long tail of permanently-free, no-cap providers — and RTK + Caveman compression (15–95% token savings) stretches that further._
