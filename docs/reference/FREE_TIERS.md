...
| **+ first month with signup credits**       | **~2.10B**        | Steady + remaining one-time signup credits (Z.AI 20M, DeepSeek 5M, agentrouter 200M, predibase 25M, …), deduped per account. **First month only** — does not recur. Together's $25 credit was removed 2026-09-04 because the credit is no longer redeemable.                                                                                                                                                                                                                                                                                                                                                                                 |
...
- **Corrected numbers:** `cloudflare-ai` 122M → **30M** (real 10k-Neurons/day), `doubao` reclassified as a one-time signup credit (not recurring), `llm7` 4M → **150M** (documented 5M tokens/day), `together` "-Free" endpoints discontinued in 2025 → **0** (the residual $25 signup credit from 2025 also sunset mid-2026; treat as no recurring free tier), `longcat` Preview ended + Flash models retired → **LongCat-2.0** only, reclassified as a one-time **10M**-token signup credit (KYC-gated, not recurring).
...
- **`together`** — The shipped note says "$25 signup credits + 3 permanently free models" but Together discontinued their $25 signup credit on 2026-09-04 (no longer redeemable per their billing page) and has no documented permanent free models in the official pricing as of 2026-09-04. Free tier effectively reduced to nothing.
