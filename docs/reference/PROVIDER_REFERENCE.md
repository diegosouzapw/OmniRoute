...
Total providers: **278**. See category breakdown below.
...
| `devin-desktop` | — | Devin Desktop | OAuth | [link](https://devin.ai) | In Devin Desktop, open the command palette and run `Devin: Copy API Key to Clipboard`, then paste the copied key here. |
...
## API Key Providers (paid / paid-with-free-credits) (187)
