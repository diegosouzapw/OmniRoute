...
| `kimi-web` | `kimi-web` | Kimi Web (Moonshot AI) | Web cookie | [link](https://www.kimi.com) | Paste your Cookie header from www.kimi.com (must contain `kimi-auth=<JWT>`). Find it via DevTools → Network → request → Cookie. |
