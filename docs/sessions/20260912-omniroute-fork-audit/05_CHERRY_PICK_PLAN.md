...
| Batch | Commit                            | Status             |
| ----- | --------------------------------- | ------------------ |
| 1     | `1eae976b28` crypto.randomInt     | **DONE** (ecc525e) |
...
### `1eae976b28` - crypto.randomInt (CodeQL #698/#699)

- **Commit:** `ecc525e432`
- **Upstream:** `1eae976b28f38b7ad972680468aae75f7c178556`
- **Files:** `src/lib/db/proxies.ts`, `tests/unit/proxy-pool-rotation-6365.test.ts`
- **Approach:** Manual cherry-pick of code files only (skipped 44 CHANGELOG/i18n files)
- **Result:** Clean apply, all pre-commit hooks passed
