...
| `MCP_SEARCH_TIMEOUT_MS`                 | `20000`     | `open-sse/mcp-server/server.ts`             | MCP fetch timeout for `/v1/search` calls used by `omniroute_web_search`. Keep above search handler timeout (~15000).          |
