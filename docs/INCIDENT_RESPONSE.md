...
**Owner**: observability-circle (lead: @KooshaPari/core, L5-118).
...
|---|---|---|---|
| Engineering on-call | @KooshaPari/core | @open-sse | Weekly, Mon 09:00 PDT |
...
|---|---|---|
| 2026-06-18 | @KooshaPari/core (L5-118) | Initial runbook; severity ladder + 15-min checklist + 4.1–4.5 mitigation runbooks. Closes 71-pillar audit L61 (1/3 → 2/3). |
