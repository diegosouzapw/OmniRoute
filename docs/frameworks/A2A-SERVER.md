...
> The Agent Card should be kept aligned with the live 356-provider catalog; provider counts and free/no-auth metadata are sourced from the runtime registry.
