...
| `diegosouzapw/omniroute` | `0.8.8`  | ~250MB  | Versão atual          |
...
- OmniRoute v0.8.8+ inclui validação via chat completions como fallback
...
- **Runtime**: Node.js 20+
- **Linguagem**: TypeScript 5.9 — **100% TypeScript** em `src/` e `open-sse/` (v0.8.8)
