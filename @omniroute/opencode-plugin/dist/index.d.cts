 ...
 */
interface OmniRoutePluginOptions {
    /**
 ...
 */
declare function resolveOmniRoutePluginOptions(opts?: OmniRoutePluginOptions): Required<Pick<OmniRoutePluginOptions, "providerId" | "displayName" | "modelCacheTtl">> & Pick<OmniRoutePluginOptions, "baseURL">;
/**
...
export { DEFAULT_MODEL_CACHE_TTL_MS, OMNIROUTE_PROVIDER_KEY, OmniRoutePlugin, type OmniRoutePluginOptions, OmniRoutePlugin as default, resolveOmniRoutePluginOptions };
