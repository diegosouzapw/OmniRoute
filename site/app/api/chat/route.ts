import { getOmniRouteApiUrl } from "@/lib/omniroute";
...
export async function POST(request: Request) {
  ...
  if (!apiKey) {
    return Response.json({
      demo: true,
      content:
        "Demo pronta. Configure OMNIROUTE_DEMO_API_KEY no site para o chat publico falar com o OmniRoute em tempo real.",
    });
  }
