# Feature 05 - Ponte OAuth compatível (auth-url, status, callback)

## Resumo executivo

- Feature 05 priorizada como **P1**, com foco em estabilizar o contrato de management e eliminar divergências entre o plano de controle e o plano de dados em /v0/management/_, /api/settings/_, /api/usage/\*.
...
- Métricas acionáveis para operação: `omniroute_feature_05_requests_total`, `omniroute_feature_05_errors_total`, `omniroute_feature_05_latency_ms`.
...
- Defaults operacionais fixados: `management.compat.enabled=true`, `management.auth.required=true`, `management.contract.version=v0`, `oauth.refresh.min_ttl_seconds=300`.
...
- Telemetria mínima para gate de rollout: `omniroute_feature_05_requests_total`, `omniroute_feature_05_errors_total`, `omniroute_feature_05_latency_ms`, `omniroute_feature_05_auth_fail_total`.
...
- Instrumentar métricas obrigatórias: `omniroute_feature_05_requests_total`, `omniroute_feature_05_errors_total`, `omniroute_feature_05_latency_ms`, `omniroute_feature_05_auth_fail_total`.
...
3. Gate para avançar: `omniroute_feature_05_errors_total` <= baseline + 1% e `omniroute_feature_05_latency_ms` <= baseline + 15% por 24h.
...
- Observabilidade ativa com métricas `omniroute_feature_05_requests_total`, `omniroute_feature_05_errors_total`, `omniroute_feature_05_latency_ms` e alertas configurados.
...
- `docs/new_features/feature-08-ponte-oauth-compativel-auth-url-status-callback.md`
