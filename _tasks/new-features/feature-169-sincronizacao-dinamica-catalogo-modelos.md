# Feature 31 - Sincronização dinâmica de catálogo de modelos

## Resumo executivo

- Feature 31 priorizada como **P1**, com foco em garantir catálogo de modelos atualizado, alias resolvidos e metadados confiáveis em /v1/models, /api/models/catalog, /api/models/alias.
...
- Métricas acionáveis para operação: `omniroute_feature_31_requests_total`, `omniroute_feature_31_errors_total`, `omniroute_feature_31_latency_ms`.
...
- Telemetria mínima para gate de rollout: `omniroute_feature_31_requests_total`, `omniroute_feature_31_errors_total`, `omniroute_feature_31_latency_ms`, `omniroute_feature_31_alias_resolve_total`.
...
- Instrumentar métricas obrigatórias: `omniroute_feature_31_requests_total`, `omniroute_feature_31_errors_total`, `omniroute_feature_31_latency_ms`, `omniroute_feature_31_alias_resolve_total`.
...
3. Gate para avançar: `omniroute_feature_31_errors_total` <= baseline + 1% e `omniroute_feature_31_latency_ms` <= baseline + 15% por 24h.
...
- Observabilidade ativa com métricas `omniroute_feature_31_requests_total`, `omniroute_feature_31_errors_total`, `omniroute_feature_31_latency_ms` e alertas configurados.
...
- `docs/new_features/feature-91-sincronizacao-dinamica-catalogo-modelos.md`
