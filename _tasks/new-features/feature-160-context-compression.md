# Feature 42 - Context compression

## Resumo executivo

- Feature 42 priorizada como **P1**, com foco em elevar previsibilidade de execução com regras de payload, cache e streaming em /api/cache\*, /v1/chat/completions, /v1/responses.
...
- Métricas acionáveis para operação: `omniroute_feature_42_requests_total`, `omniroute_feature_42_errors_total`, `omniroute_feature_42_latency_ms`.
...
- Telemetria mínima para gate de rollout: `omniroute_feature_42_requests_total`, `omniroute_feature_42_errors_total`, `omniroute_feature_42_latency_ms`.
...
- Instrumentar métricas obrigatórias: `omniroute_feature_42_requests_total`, `omniroute_feature_42_errors_total`, `omniroute_feature_42_latency_ms`.
...
3. Gate para avançar: `omniroute_feature_42_errors_total` <= baseline + 1% e `omniroute_feature_42_latency_ms` <= baseline + 15% por 24h.
...
- Observabilidade ativa com métricas `omniroute_feature_42_requests_total`, `omniroute_feature_42_errors_total`, `omniroute_feature_42_latency_ms` e alertas configurados.
...
- `docs/new_features/feature-105-context-compression.md`
