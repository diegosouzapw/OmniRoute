# Feature 33 - Clamp de reasoning effort no Codex

## Resumo executivo

- Feature 33 priorizada como **P1**, com foco em garantir catálogo de modelos atualizado, alias resolvidos e metadados confiáveis em /v1/models, /api/models/catalog, /api/models/alias.
...
- Métricas acionáveis para operação: `omniroute_feature_33_requests_total`, `omniroute_feature_33_errors_total`, `omniroute_feature_33_latency_ms`.
...
- Telemetria mínima para gate de rollout: `omniroute_feature_33_requests_total`, `omniroute_feature_33_errors_total`, `omniroute_feature_33_latency_ms`.
...
- Instrumentar métricas obrigatórias: `omniroute_feature_33_requests_total`, `omniroute_feature_33_errors_total`, `omniroute_feature_33_latency_ms`.
...
3. Gate para avançar: `omniroute_feature_33_errors_total` <= baseline + 1% e `omniroute_feature_33_latency_ms` <= baseline + 15% por 24h.
...
- Observabilidade ativa com métricas `omniroute_feature_33_requests_total`, `omniroute_feature_33_errors_total`, `omniroute_feature_33_latency_ms` e alertas configurados.
...
- `docs/new_features/feature-07-clamp-de-effort-por-modelo-codex.md`
- `docs/new_features/feature-34-clamp-de-effort-por-modelo-no-codex.md`
