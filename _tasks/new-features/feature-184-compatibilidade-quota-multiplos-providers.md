# Feature 17 - Compatibilidade de quota em múltiplos providers

## Resumo executivo

- Feature 17 priorizada como **P1**, com foco em reduzir falhas transitórias com retry/cooldown/failover determinísticos em /v1/chat/completions, /v1/responses, /v1/models.
...
- Métricas acionáveis para operação: `omniroute_feature_17_requests_total`, `omniroute_feature_17_errors_total`, `omniroute_feature_17_latency_ms`.
...
- Telemetria mínima para gate de rollout: `omniroute_feature_17_requests_total`, `omniroute_feature_17_errors_total`, `omniroute_feature_17_latency_ms`, `omniroute_feature_17_quota_switch_total`.
...
- Instrumentar métricas obrigatórias: `omniroute_feature_17_requests_total`, `omniroute_feature_17_errors_total`, `omniroute_feature_17_latency_ms`, `omniroute_feature_17_quota_switch_total`.
...
3. Gate para avançar: `omniroute_feature_17_errors_total` <= baseline + 1% e `omniroute_feature_17_latency_ms` <= baseline + 15% por 24h.
...
- Observabilidade ativa com métricas `omniroute_feature_17_requests_total`, `omniroute_feature_17_errors_total`, `omniroute_feature_17_latency_ms` e alertas configurados.
...
- `docs/new_features/feature-25-compatibilidade-de-quota-multiplos-providers.md`
- `docs/new_features/feature-68-compatibilidade-de-quota-em-multiplos-providers-claude-kimi-antigravity.md`
