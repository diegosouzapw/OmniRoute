# Feature 11 - Modo remote-management controlado

## Resumo executivo

- Feature 11 priorizada como **P1**, com foco em estabilizar o contrato de management e eliminar divergências entre o plano de controle e o plano de dados em /v0/management/_, /api/settings/_, /api/usage/\*.
...
- Métricas acionáveis para operação: `omniroute_feature_11_requests_total`, `omniroute_feature_11_errors_total`, `omniroute_feature_11_latency_ms`.
...
- Telemetria mínima para gate de rollout: `omniroute_feature_11_requests_total`, `omniroute_feature_11_errors_total`, `omniroute_feature_11_latency_ms`.
...
- Instrumentar métricas obrigatórias: `omniroute_feature_11_requests_total`, `omniroute_feature_11_errors_total`, `omniroute_feature_11_latency_ms`.
...
3. Gate para avançar: `omniroute_feature_11_errors_total` <= baseline + 1% e `omniroute_feature_11_latency_ms` <= baseline + 15% por 24h.
...
- Observabilidade ativa com métricas `omniroute_feature_11_requests_total`, `omniroute_feature_11_errors_total`, `omniroute_feature_11_latency_ms` e alertas configurados.
...
- `docs/new_features/feature-19-modo-proxy-remoto-local-controlado.md`
- `docs/new_features/feature-52-modo-proxy-remoto-local-controlado.md`
