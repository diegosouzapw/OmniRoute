# Feature 48 - Codex multi-account com `chatgpt-account-id`

## Resumo executivo

- Feature 48 priorizada como **P1**, com foco em fortalecer sync, ownership de tokens e discovery dinâmico com rastreabilidade em superfícies de proxy e management.
...
- Métricas acionáveis para operação: `omniroute_feature_48_requests_total`, `omniroute_feature_48_errors_total`, `omniroute_feature_48_latency_ms`.
...
- Telemetria mínima para gate de rollout: `omniroute_feature_48_requests_total`, `omniroute_feature_48_errors_total`, `omniroute_feature_48_latency_ms`.
...
- Instrumentar métricas obrigatórias: `omniroute_feature_48_requests_total`, `omniroute_feature_48_errors_total`, `omniroute_feature_48_latency_ms`.
...
3. Gate para avançar: `omniroute_feature_48_errors_total` <= baseline + 1% e `omniroute_feature_48_latency_ms` <= baseline + 15% por 24h.
...
- Observabilidade ativa com métricas `omniroute_feature_48_requests_total`, `omniroute_feature_48_errors_total`, `omniroute_feature_48_latency_ms` e alertas configurados.
...
- `docs/new_features/feature-94-codex-multi-account-chatgpt-account-id.md`
