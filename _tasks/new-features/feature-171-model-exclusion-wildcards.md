# Feature 30 - Exclusão de modelos com wildcards

## Resumo executivo

- Feature 30 priorizada como **P1**, com foco em garantir catálogo de modelos atualizado, alias resolvidos e metadados confiáveis em /v1/models, /api/models/catalog, /api/models/alias.
...
- Métricas acionáveis para operação: `omniroute_feature_30_requests_total`, `omniroute_feature_30_errors_total`, `omniroute_feature_30_latency_ms`.
...
- Telemetria mínima para gate de rollout: `omniroute_feature_30_requests_total`, `omniroute_feature_30_errors_total`, `omniroute_feature_30_latency_ms`, `omniroute_feature_30_alias_resolve_total`.
...
- Instrumentar métricas obrigatórias: `omniroute_feature_30_requests_total`, `omniroute_feature_30_errors_total`, `omniroute_feature_30_latency_ms`, `omniroute_feature_30_alias_resolve_total`.
...
3. Gate para avançar: `omniroute_feature_30_errors_total` <= baseline + 1% e `omniroute_feature_30_latency_ms` <= baseline + 15% por 24h.
...
- Observabilidade ativa com métricas `omniroute_feature_30_requests_total`, `omniroute_feature_30_errors_total`, `omniroute_feature_30_latency_ms` e alertas configurados.
...
- `docs/new_features/feature-109-model-exclusion-wildcards.md`
