# Feature 23 - Rate limit de login e endpoints sensíveis

## Resumo executivo

- Feature 23 priorizada como **P1**, com foco em endurecer a borda do serviço contra abuso, SSRF e chamadas inseguras em /api/auth/_, /api/providers/validate, /v0/management/_.
...
- Métricas acionáveis para operação: `omniroute_feature_23_requests_total`, `omniroute_feature_23_errors_total`, `omniroute_feature_23_latency_ms`.
...
- Telemetria mínima para gate de rollout: `omniroute_feature_23_requests_total`, `omniroute_feature_23_errors_total`, `omniroute_feature_23_latency_ms`.
...
- Instrumentar métricas obrigatórias: `omniroute_feature_23_requests_total`, `omniroute_feature_23_errors_total`, `omniroute_feature_23_latency_ms`.
...
3. Gate para avançar: `omniroute_feature_23_errors_total` <= baseline + 1% e `omniroute_feature_23_latency_ms` <= baseline + 15% por 24h.
...
- Observabilidade ativa com métricas `omniroute_feature_23_requests_total`, `omniroute_feature_23_errors_total`, `omniroute_feature_23_latency_ms` e alertas configurados.
...
- `docs/new_features/feature-35-rate-limit-de-login-e-endpoints-sensiveis.md`
- `docs/new_features/feature-71-rate-limit-de-login-e-endpoints-sensiveis.md`
