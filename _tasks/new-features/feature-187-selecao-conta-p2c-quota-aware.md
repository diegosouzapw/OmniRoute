# Feature 14 - Seleção de conta P2C quota-aware

## Resumo executivo

- Feature 14 priorizada como **P1**, com foco em reduzir falhas transitórias com retry/cooldown/failover determinísticos em /v1/chat/completions, /v1/responses, /v1/models.
...
- Métricas acionáveis para operação: `omniroute_feature_14_requests_total`, `omniroute_feature_14_errors_total`, `omniroute_feature_14_latency_ms`.
...
- Telemetria mínima para gate de rollout: `omniroute_feature_14_requests_total`, `omniroute_feature_14_errors_total`, `omniroute_feature_14_latency_ms`, `omniroute_feature_14_quota_switch_total`.
...
- Instrumentar métricas obrigatórias: `omniroute_feature_14_requests_total`, `omniroute_feature_14_errors_total`, `omniroute_feature_14_latency_ms`, `omniroute_feature_14_quota_switch_total`.
...
3. Gate para avançar: `omniroute_feature_14_errors_total` <= baseline + 1% e `omniroute_feature_14_latency_ms` <= baseline + 15% por 24h.
...
- Observabilidade ativa com métricas `omniroute_feature_14_requests_total`, `omniroute_feature_14_errors_total`, `omniroute_feature_14_latency_ms` e alertas configurados.
...
- `docs/new_features/feature-40-integracao-estrategia-p2c-no-auth.md`
- `docs/new_features/feature-63-integracao-real-da-estrategia-p2c-no-selecionador-de-contas.md`
