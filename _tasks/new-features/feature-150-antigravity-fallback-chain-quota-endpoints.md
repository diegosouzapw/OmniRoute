# Feature 50 - Antigravity fallback chain e quota endpoints

## Resumo executivo

- Feature 50 priorizada como **P1**, com foco em fortalecer sync, ownership de tokens e discovery dinâmico com rastreabilidade em superfícies de proxy e management.
...
- Métricas acionáveis para operação: `omniroute_feature_50_requests_total`, `omniroute_feature_50_errors_total`, `omniroute_feature_50_latency_ms`.
...
- Códigos de erro obrigatórios: `INTERNAL_PROXY_ERROR`, `QUOTA_EXHAUSTED`, `SYNC_TOKEN_INVALID`, `SYNC_CONFLICT`, `DISCOVERY_UPSTREAM_UNAVAILABLE`.
- Telemetria mínima para gate de rollout: `omniroute_feature_50_requests_total`, `omniroute_feature_50_errors_total`, `omniroute_feature_50_latency_ms`, `omniroute_feature_50_quota_switch_total`.
...
2. Em `open-sse/config/constants.js`, criar/ajustar constantes, enums e helpers para erros tipados (`INTERNAL_PROXY_ERROR`, `QUOTA_EXHAUSTED`, `SYNC_TOKEN_INVALID`).
...
- Instrumentar métricas obrigatórias: `omniroute_feature_50_requests_total`, `omniroute_feature_50_errors_total`, `omniroute_feature_50_latency_ms`, `omniroute_feature_50_quota_switch_total`.
...
3. Gate para avançar: `omniroute_feature_50_errors_total` <= baseline + 1% e `omniroute_feature_50_latency_ms` <= baseline + 15% por 24h.
...
- Observabilidade ativa com métricas `omniroute_feature_50_requests_total`, `omniroute_feature_50_errors_total`, `omniroute_feature_50_latency_ms` e alertas configurados.
...
- `docs/new_features/feature-98-antigravity-fallback-chain-quota-endpoints.md`
