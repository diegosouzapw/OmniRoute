# Feature 36 - Atualização de constantes/endpoints Codex e Antigravity

## Resumo executivo

- Feature 36 priorizada como **P1**, com foco em garantir catálogo de modelos atualizado, alias resolvidos e metadados confiáveis em superfícies de proxy e management.
...
- Métricas acionáveis para operação: `omniroute_feature_36_requests_total`, `omniroute_feature_36_errors_total`, `omniroute_feature_36_latency_ms`.
...
- Códigos de erro obrigatórios: `INTERNAL_PROXY_ERROR`, `MODEL_NOT_MAPPED`, `MODEL_ALIAS_AMBIGUOUS`, `DISCOVERY_UPSTREAM_UNAVAILABLE`.
- Telemetria mínima para gate de rollout: `omniroute_feature_36_requests_total`, `omniroute_feature_36_errors_total`, `omniroute_feature_36_latency_ms`.
...
- Instrumentar métricas obrigatórias: `omniroute_feature_36_requests_total`, `omniroute_feature_36_errors_total`, `omniroute_feature_36_latency_ms`.
...
3. Gate para avançar: `omniroute_feature_36_errors_total` <= baseline + 1% e `omniroute_feature_36_latency_ms` <= baseline + 15% por 24h.
...
- Observabilidade ativa com métricas `omniroute_feature_36_requests_total`, `omniroute_feature_36_errors_total`, `omniroute_feature_36_latency_ms` e alertas configurados.
...
- `docs/new_features/feature-49-atualizacao-constantes-codex-antigravity.md`
- `docs/new_features/feature-66-atualizacao-de-constantes-e-endpoints-codex-antigravity.md`
