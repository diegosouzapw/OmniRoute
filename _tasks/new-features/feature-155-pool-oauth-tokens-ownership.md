# Feature 46 - Pool compartilhado de tokens OAuth com ownership

## Resumo executivo

- Feature 46 priorizada como **P1**, com foco em fortalecer sync, ownership de tokens e discovery dinâmico com rastreabilidade em /api/sync/_, /api/cloud/_.
...
- Métricas acionáveis para operação: `omniroute_feature_46_requests_total`, `omniroute_feature_46_errors_total`, `omniroute_feature_46_latency_ms`.
...
- Defaults operacionais fixados: `sync.share_code.ttl_seconds=900`, `oauth.pool.ownership_mode=strict`, `antigravity.discovery.interval_ms=180000`, `oauth.refresh.min_ttl_seconds=300`.
...
- Telemetria mínima para gate de rollout: `omniroute_feature_46_requests_total`, `omniroute_feature_46_errors_total`, `omniroute_feature_46_latency_ms`, `omniroute_feature_46_auth_fail_total`.
...
- Instrumentar métricas obrigatórias: `omniroute_feature_46_requests_total`, `omniroute_feature_46_errors_total`, `omniroute_feature_46_latency_ms`, `omniroute_feature_46_auth_fail_total`.
...
3. Gate para avançar: `omniroute_feature_46_errors_total` <= baseline + 1% e `omniroute_feature_46_latency_ms` <= baseline + 15% por 24h.
...
- Observabilidade ativa com métricas `omniroute_feature_46_requests_total`, `omniroute_feature_46_errors_total`, `omniroute_feature_46_latency_ms` e alertas configurados.
...
- Complexidade estimada: **Alta (5-8 dias)**.
...
- `docs/new_features/feature-43-governanca-de-ownership-por-credencial.md`
- `docs/new_features/feature-74-governanca-de-ownership-por-credencial.md`
- `docs/new_features/feature-104-pool-compartilhado-oauth-tokens-com-ownership.md`
