# Feature 20 - Cooldown por provider com failover automático

## Resumo executivo

- Feature 20 priorizada como **P1**, com foco em reduzir falhas transitórias com retry/cooldown/failover determinísticos em /v1/chat/completions, /v1/responses, /v1/models.
...
- Métricas acionáveis para operação: `omniroute_feature_20_requests_total`, `omniroute_feature_20_errors_total`, `omniroute_feature_20_latency_ms`.
...
- Defaults operacionais fixados: `routing.retry.max_attempts=2`, `routing.retry.base_delay_ms=250`, `routing.cooldown.default_ttl_ms=30000`, `routing.cooldown.header_retry_after=true`.
...
- Telemetria mínima para gate de rollout: `omniroute_feature_20_requests_total`, `omniroute_feature_20_errors_total`, `omniroute_feature_20_latency_ms`.
...
- Instrumentar métricas obrigatórias: `omniroute_feature_20_requests_total`, `omniroute_feature_20_errors_total`, `omniroute_feature_20_latency_ms`.
...
3. Gate para avançar: `omniroute_feature_20_errors_total` <= baseline + 1% e `omniroute_feature_20_latency_ms` <= baseline + 15% por 24h.
...
- Observabilidade ativa com métricas `omniroute_feature_20_requests_total`, `omniroute_feature_20_errors_total`, `omniroute_feature_20_latency_ms` e alertas configurados.
...
- `docs/new_features/feature-83-cooldown-provider-com-failover-automatico.md`
