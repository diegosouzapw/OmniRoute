# Feature 40 - Response cache

## Resumo executivo

- Feature 40 priorizada como **P1**, com foco em elevar previsibilidade de execução com regras de payload, cache e streaming em /api/cache\*, /v1/chat/completions, /v1/responses.
...
- Métricas acionáveis para operação: `omniroute_feature_40_requests_total`, `omniroute_feature_40_errors_total`, `omniroute_feature_40_latency_ms`.
...
- Telemetria mínima para gate de rollout: `omniroute_feature_40_requests_total`, `omniroute_feature_40_errors_total`, `omniroute_feature_40_latency_ms`, `omniroute_feature_40_cache_hit_ratio`.
...
- Instrumentar métricas obrigatórias: `omniroute_feature_40_requests_total`, `omniroute_feature_40_errors_total`, `omniroute_feature_40_latency_ms`, `omniroute_feature_40_cache_hit_ratio`.
...
3. Gate para avançar: `omniroute_feature_40_errors_total` <= baseline + 1% e `omniroute_feature_40_latency_ms` <= baseline + 15% por 24h.
...
- Observabilidade ativa com métricas `omniroute_feature_40_requests_total`, `omniroute_feature_40_errors_total`, `omniroute_feature_40_latency_ms` e alertas configurados.
...
- `docs/new_features/feature-114-response-cache.md`
