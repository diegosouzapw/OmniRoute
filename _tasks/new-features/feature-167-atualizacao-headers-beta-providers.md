# Feature 34 - Atualização de headers beta por provider

## Resumo executivo

- Feature 34 priorizada como **P1**, com foco em garantir catálogo de modelos atualizado, alias resolvidos e metadados confiáveis em superfícies de proxy e management.
...
- Métricas acionáveis para operação: `omniroute_feature_34_requests_total`, `omniroute_feature_34_errors_total`, `omniroute_feature_34_latency_ms`.
...
- Defaults operacionais fixados: `models.registry.sync_interval_ms=300000`, `models.alias.strict_mode=true`, `models.capabilities.versioned=true`, `proxy.headers.beta.enabled=true`.
...
- Telemetria mínima para gate de rollout: `omniroute_feature_34_requests_total`, `omniroute_feature_34_errors_total`, `omniroute_feature_34_latency_ms`.
...
- Instrumentar métricas obrigatórias: `omniroute_feature_34_requests_total`, `omniroute_feature_34_errors_total`, `omniroute_feature_34_latency_ms`.
...
3. Gate para avançar: `omniroute_feature_34_errors_total` <= baseline + 1% e `omniroute_feature_34_latency_ms` <= baseline + 15% por 24h.
...
- Observabilidade ativa com métricas `omniroute_feature_34_requests_total`, `omniroute_feature_34_errors_total`, `omniroute_feature_34_latency_ms` e alertas configurados.
...
- `docs/new_features/feature-14-paridade-headers-antigravity.md`
- `docs/new_features/feature-44-paridade-de-headers-antigravity.md`
- `docs/new_features/feature-92-atualizacao-headers-provider-beta-versoes.md`
