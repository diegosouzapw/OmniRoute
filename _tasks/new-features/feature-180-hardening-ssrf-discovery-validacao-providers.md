# Feature 22 - Hardening SSRF em discovery e validação de providers

## Resumo executivo

- Feature 22 priorizada como **P1**, com foco em endurecer a borda do serviço contra abuso, SSRF e chamadas inseguras em /api/auth/_, /api/providers/validate, /v0/management/_.
...
- Métricas acionáveis para operação: `omniroute_feature_22_requests_total`, `omniroute_feature_22_errors_total`, `omniroute_feature_22_latency_ms`.
...
- Telemetria mínima para gate de rollout: `omniroute_feature_22_requests_total`, `omniroute_feature_22_errors_total`, `omniroute_feature_22_latency_ms`.
...
- Instrumentar métricas obrigatórias: `omniroute_feature_22_requests_total`, `omniroute_feature_22_errors_total`, `omniroute_feature_22_latency_ms`.
...
3. Gate para avançar: `omniroute_feature_22_errors_total` <= baseline + 1% e `omniroute_feature_22_latency_ms` <= baseline + 15% por 24h.
...
- Observabilidade ativa com métricas `omniroute_feature_22_requests_total`, `omniroute_feature_22_errors_total`, `omniroute_feature_22_latency_ms` e alertas configurados.
...
- Complexidade estimada: **Alta (3-6 dias)**.
...
- `docs/new_features/feature-28-hardening-ssrf-discovery-e-validacao-de-providers.md`
- `docs/new_features/feature-69-hardening-ssrf-em-discovery-e-validacao-de-providers.md`
