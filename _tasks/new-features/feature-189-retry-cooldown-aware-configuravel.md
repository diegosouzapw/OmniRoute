# Feature 12 - Retry cooldown-aware configurável

## Resumo executivo

- Feature 12 priorizada como **P1**, com foco em reduzir falhas transitórias com retry/cooldown/failover determinísticos em /v1/chat/completions, /v1/responses, /v1/models.
...
- Métricas acionáveis para operação: `omniroute_feature_12_requests_total`, `omniroute_feature_12_errors_total`, `omniroute_feature_12_latency_ms`.
...
- Telemetria mínima para gate de rollout: `omniroute_feature_12_requests_total`, `omniroute_feature_12_errors_total`, `omniroute_feature_12_latency_ms`, `omniroute_feature_12_retry_attempt_total`.
...
- Instrumentar métricas obrigatórias: `omniroute_feature_12_requests_total`, `omniroute_feature_12_errors_total`, `omniroute_feature_12_latency_ms`, `omniroute_feature_12_retry_attempt_total`.
...
3. Gate para avançar: `omniroute_feature_12_errors_total` <= baseline + 1% e `omniroute_feature_12_latency_ms` <= baseline + 15% por 24h.
...
- Observabilidade ativa com métricas `omniroute_feature_12_requests_total`, `omniroute_feature_12_errors_total`, `omniroute_feature_12_latency_ms` e alertas configurados.
...
- `docs/new_features/feature-36-retry-cooldown-aware-com-config.md`
- `docs/new_features/feature-61-retry-aware-de-cooldown-com-configuracao-operacional.md`
