# Feature 13 - Erro `model_cooldown` com `Retry-After`

## Resumo executivo

- Feature 13 priorizada como **P1**, com foco em reduzir falhas transitórias com retry/cooldown/failover determinísticos em /v1/chat/completions, /v1/responses, /v1/models.
...
- Métricas acionáveis para operação: `omniroute_feature_13_requests_total`, `omniroute_feature_13_errors_total`, `omniroute_feature_13_latency_ms`.
...
- Defaults operacionais fixados: `routing.retry.max_attempts=2`, `routing.retry.base_delay_ms=250`, `routing.cooldown.default_ttl_ms=30000`, `routing.retry.jitter_ratio=0.2`, `routing.cooldown.header_retry_after=true`.
- Headers obrigatórios de diagnóstico: `X-Request-Id`, `Retry-After`, `X-RateLimit-Remaining`.
- Códigos de erro obrigatórios: `INTERNAL_PROXY_ERROR`, `RETRY_EXHAUSTED`, `UPSTREAM_RATE_LIMITED`, `MODEL_COOLDOWN_ACTIVE`.
- Telemetria mínima para gate de rollout: `omniroute_feature_13_requests_total`, `omniroute_feature_13_errors_total`, `omniroute_feature_13_latency_ms`, `omniroute_feature_13_retry_attempt_total`, `omniroute_feature_13_alias_resolve_total`.
...
- Instrumentar métricas obrigatórias: `omniroute_feature_13_requests_total`, `omniroute_feature_13_errors_total`, `omniroute_feature_13_latency_ms`, `omniroute_feature_13_retry_attempt_total`, `omniroute_feature_13_alias_resolve_total`.
...
3. Gate para avançar: `omniroute_feature_13_errors_total` <= baseline + 1% e `omniroute_feature_13_latency_ms` <= baseline + 15% por 24h.
...
- Observabilidade ativa com métricas `omniroute_feature_13_requests_total`, `omniroute_feature_13_errors_total`, `omniroute_feature_13_latency_ms` e alertas configurados.
...
- `docs/new_features/feature-38-erro-model-cooldown-com-retry-after.md`
- `docs/new_features/feature-62-erro-estruturado-model-cooldown-com-header-retry-after.md`
