# Feature 28 - Expansão do catálogo de modelos atualizados

## Resumo executivo

- Feature 28 priorizada como **P1**, com foco em garantir catálogo de modelos atualizado, alias resolvidos e metadados confiáveis em /v1/models, /api/models/catalog, /api/models/alias.
...
- Métricas acionáveis para operação: `omniroute_feature_28_requests_total`, `omniroute_feature_28_errors_total`, `omniroute_feature_28_latency_ms`.
...
- Telemetria mínima para gate de rollout: `omniroute_feature_28_requests_total`, `omniroute_feature_28_errors_total`, `omniroute_feature_28_latency_ms`, `omniroute_feature_28_alias_resolve_total`.
...
- Instrumentar métricas obrigatórias: `omniroute_feature_28_requests_total`, `omniroute_feature_28_errors_total`, `omniroute_feature_28_latency_ms`, `omniroute_feature_28_alias_resolve_total`.
...
3. Gate para avançar: `omniroute_feature_28_errors_total` <= baseline + 1% e `omniroute_feature_28_latency_ms` <= baseline + 15% por 24h.
...
- Observabilidade ativa com métricas `omniroute_feature_28_requests_total`, `omniroute_feature_28_errors_total`, `omniroute_feature_28_latency_ms` e alertas configurados.
...
- `docs/new_features/feature-47-expansao-catalogo-modelos-e-capacidades.md`
- `docs/new_features/feature-65-expansao-de-catalogo-de-modelos-registro-de-capacidades.md`
- `docs/new_features/feature-107-missing-models-update.md`
