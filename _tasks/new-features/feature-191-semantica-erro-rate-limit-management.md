# Feature 10 - Semântica de erro/rate-limit em management

## Resumo executivo

- Feature 10 priorizada como **P1**, com foco em estabilizar o contrato de management e eliminar divergências entre o plano de controle e o plano de dados em /v0/management/_, /api/settings/_, /api/usage/\*.
...
- Métricas acionáveis para operação: `omniroute_feature_10_requests_total`, `omniroute_feature_10_errors_total`, `omniroute_feature_10_latency_ms`.
...
- Headers obrigatórios de diagnóstico: `X-Request-Id`, `X-Omniroute-Version`, `X-Omniroute-Build`, `Retry-After`, `X-RateLimit-Remaining`.
- Códigos de erro obrigatórios: `INTERNAL_PROXY_ERROR`, `MGMT_UNAUTHORIZED`, `MGMT_FORBIDDEN_SCOPE`.
- Telemetria mínima para gate de rollout: `omniroute_feature_10_requests_total`, `omniroute_feature_10_errors_total`, `omniroute_feature_10_latency_ms`.
...
- Instrumentar métricas obrigatórias: `omniroute_feature_10_requests_total`, `omniroute_feature_10_errors_total`, `omniroute_feature_10_latency_ms`.
...
3. Gate para avançar: `omniroute_feature_10_errors_total` <= baseline + 1% e `omniroute_feature_10_latency_ms` <= baseline + 15% por 24h.
...
- Observabilidade ativa com métricas `omniroute_feature_10_requests_total`, `omniroute_feature_10_errors_total`, `omniroute_feature_10_latency_ms` e alertas configurados.
...
- `docs/new_features/feature-17-paridade-de-semantica-de-erro-rate-limit-para-clients-de-management.md`
