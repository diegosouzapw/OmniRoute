...
} from "./chatCore/chatLogHelpers.ts";
...
// ── Memory / chat-log helpers ────────────────────────────────────────────
// Extracted to ./chatCore/chatLogHelpers.ts (PR-5 of the perf workstream).
// Imported above; the inline definitions that used to live here have moved.
// Keep this comment as the breadcrumb for anyone tracing the old location.
