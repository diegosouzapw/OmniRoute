...
export function makeOnStreamComplete(
  ...
  return ({
    ...
    storeStreamingSemanticCacheResponse({
      ...
      streamStatus,
      streamResponseBody: streamResponseBody as Record<string, unknown> | null | undefined,
      body: bodyForCacheWrite as {
        messages?: unknown;
        input?: unknown;
        temperature?: number;
        top_p?: number;
      ...
      streamUsage: streamUsage as Record<string, unknown> | null | undefined,
      log,
    });
