...
export const OAUTH_ENDPOINTS = {
  ...
  qoder: {
    // Device token polling endpoint (used during /login browser flow)
    token: "https://openapi.qoder.sh/algo/api/v2/byok/config/api/v1/deviceToken/poll",
    auth: "https://center.qoder.sh",
  },
  github: {
