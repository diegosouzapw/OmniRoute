...
export const REGISTRY: Record<string, RegistryEntry> = {
  ...
  "nous-research": {
    ...
    format: "openai",
    executor: "default",
    baseUrl: "https://api.nousresearch.com/v1/chat/completions",
    authType: "oauth",
    authHeader: "bearer",
    oauth: {
      tokenUrl: "https://api.nousresearch.com/oauth/token",
      authUrl: "https://api.nousresearch.com/oauth/authorize",
    },
    models: [
      { id: "hermes-3-llama-3.1-405b", name: "Hermes 3 405B" },
      { id: "hermes-2-pro-llama-3-8b", name: "Hermes 2 Pro 8B" },
    ],
  },
  gradient: {
    id: "gradient",
  ...
  zed: {
    ...
    authHeader: "bearer",
    oauth: {
      tokenUrl: "https://api.zed.dev/oauth/token",
      authUrl: "https://api.zed.dev/oauth/authorize",
    },
    models: [],
    passthroughModels: true,
  },
  trae: {
    ...
    authHeader: "bearer",
    oauth: {
      tokenUrl: "https://api.trae.ai/oauth/token",
      authUrl: "https://api.trae.ai/oauth/authorize",
    },
    models: [],
    passthroughModels: true,
  },
