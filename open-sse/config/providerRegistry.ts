...
export const REGISTRY: Record<string, RegistryEntry> = {
  ...
  gradient: {
    ...
    format: "openai",
    executor: "default",
    baseUrl: "https://api.gradient.network/v1/chat/completions",
    authType: "apikey",
    authHeader: "bearer",
    models: [],
    passthroughModels: true,
  ...
  oci: {
    ...
    authHeader: "bearer",
    models: [
      { id: "cohere.command-r-plus-08-2024", name: "Command R+ (OCI)" },
      { id: "meta.llama-3.1-405b-instruct", name: "Llama 3.1 405B (OCI)" },
    ],
  },
  watsonx: {
    id: "watsonx",
    ...
    authHeader: "bearer",
    models: [
      { id: "ibm/granite-3-8b-instruct", name: "Granite 3 8B (WatsonX)" },
      { id: "meta-llama/llama-3-1-70b-instruct", name: "Llama 3.1 70B (WatsonX)" },
    ],
  },
  sagemaker: {
    id: "sagemaker",
  ...
  datarobot: {
    ...
    format: "openai",
    executor: "default",
    baseUrl: "https://api.datarobot.com/api/v2/deployments",
    authType: "apikey",
    authHeader: "bearer",
    models: [],
    passthroughModels: true,
  ...
  codebuddy: {
    ...
    format: "kiro",
    executor: "kiro",
    baseUrl: "https://api.codebuddy.dev/v1/chat/completions",
    authType: "oauth",
    authHeader: "bearer",
    oauth: {
      tokenUrl: "https://api.codebuddy.dev/oauth/token",
      authUrl: "https://api.codebuddy.dev/oauth/authorize",
    },
    models: [
