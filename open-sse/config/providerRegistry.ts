...
const WATSONX_CHAT_MODELS: RegistryModel[] = buildModels(WATSONX_CHAT_MODEL_IDS);

const OCI_CHAT_MODEL_IDS = [
...
const OCI_CHAT_MODELS: RegistryModel[] = buildModels(OCI_CHAT_MODEL_IDS);

const AZURE_AI_CHAT_MODEL_IDS = [
  "claude-haiku-4-5",
  "claude-opus-4-1",
  "claude-opus-4-5",
  "claude-opus-4-6",
...
const AZURE_AI_CHAT_MODELS: RegistryModel[] = AZURE_AI_CHAT_MODEL_IDS.map((id) => ({
  id,
  name: id,
  ...(id.toLowerCase().startsWith("claude-") ? { targetFormat: "claude" } : {}),
}));

const AZURE_OPENAI_MODEL_DEFINITIONS = [
  ["codex-mini", "responses"],
  ["command-r-plus", "chat"],
  ["computer-use-preview", "chat"],
  ["container", "chat"],
  ["eu/gpt-4o-2024-08-06", "chat"],
  ["eu/gpt-4o-2024-11-20", "chat"],
  ["eu/gpt-4o-mini-2024-07-18", "chat"],
  ["eu/gpt-4o-mini-realtime-preview-2024-12-17", "chat"],
  ["eu/gpt-4o-realtime-preview-2024-10-01", "chat"],
  ["eu/gpt-4o-realtime-preview-2024-12-17", "chat"],
  ["eu/gpt-5-2025-08-07", "chat"],
  ["eu/gpt-5-mini-2025-08-07", "chat"],
  ["eu/gpt-5-nano-2025-08-07", "chat"],
  ["eu/gpt-5.1", "chat"],
  ["eu/gpt-5.1-chat", "chat"],
  ["eu/gpt-5.1-codex", "responses"],
  ["eu/gpt-5.1-codex-mini", "responses"],
  ["eu/o1-2024-12-17", "chat"],
  ["eu/o1-mini-2024-09-12", "chat"],
  ["eu/o1-preview-2024-09-12", "chat"],
  ["eu/o3-mini-2025-01-31", "chat"],
  ["global-standard/gpt-4o-2024-08-06", "chat"],
  ["global-standard/gpt-4o-2024-11-20", "chat"],
  ["global-standard/gpt-4o-mini", "chat"],
  ["global/gpt-4o-2024-08-06", "chat"],
  ["global/gpt-4o-2024-11-20", "chat"],
  ["global/gpt-5.1", "chat"],
  ["global/gpt-5.1-chat", "chat"],
  ["global/gpt-5.1-codex", "responses"],
  ["global/gpt-5.1-codex-mini", "responses"],
  ["gpt-3.5-turbo", "chat"],
  ["gpt-3.5-turbo-0125", "chat"],
  ["gpt-35-turbo", "chat"],
  ["gpt-35-turbo-0125", "chat"],
  ["gpt-35-turbo-1106", "chat"],
  ["gpt-35-turbo-16k", "chat"],
  ["gpt-35-turbo-16k-0613", "chat"],
  ["gpt-4", "chat"],
  ...
  ["gpt-4-turbo-vision-preview", "chat"],
  ["gpt-4.1", "chat"],
  ...
  ["gpt-4o-realtime-preview-2024-10-01", "chat"],
  ["gpt-4o-realtime-preview-2024-12-17", "chat"],
  ["gpt-5", "chat"],
  ["gpt-5-2025-08-07", "chat"],
  ["gpt-5-chat", "chat"],
  ...
  ["gpt-5-pro", "responses"],
  ["gpt-5.1", "chat"],
  ["gpt-5.1-2025-11-13", "chat"],
  ["gpt-5.1-chat", "chat"],
  ["gpt-5.1-chat-2025-11-13", "chat"],
  ["gpt-5.1-codex", "responses"],
  ["gpt-5.1-codex-2025-11-13", "responses"],
  ["gpt-5.1-codex-max", "responses"],
  ["gpt-5.1-codex-mini", "responses"],
  ["gpt-5.1-codex-mini-2025-11-13", "responses"],
  ["gpt-5.2", "chat"],
  ["gpt-5.2-2025-12-11", "chat"],
  ["gpt-5.2-chat", "chat"],
  ["gpt-5.2-chat-2025-12-11", "chat"],
  ["gpt-5.2-codex", "responses"],
  ["gpt-5.2-pro", "responses"],
  ["gpt-5.2-pro-2025-12-11", "responses"],
  ["gpt-5.3-chat", "chat"],
  ["gpt-5.3-codex", "responses"],
  ["gpt-5.4", "chat"],
  ["gpt-5.4-2026-03-05", "chat"],
  ["gpt-5.4-mini", "chat"],
  ["gpt-5.4-nano", "chat"],
  ["gpt-5.4-pro", "responses"],
  ["gpt-5.4-pro-2026-03-05", "responses"],
  ["gpt-audio-1.5-2026-02-23", "chat"],
  ["gpt-audio-2025-08-28", "chat"],
  ["gpt-audio-mini-2025-10-06", "chat"],
  ["gpt-realtime-1.5-2026-02-23", "chat"],
  ["gpt-realtime-2025-08-28", "chat"],
  ["gpt-realtime-mini-2025-10-06", "chat"],
  ["mistral-large-2402", "chat"],
  ...
  ["o3-pro", "responses"],
  ["o3-pro-2025-06-10", "responses"],
  ["o4-mini", "chat"],
  ["o4-mini-2025-04-16", "chat"],
  ["us/gpt-4.1-2025-04-14", "chat"],
  ["us/gpt-4.1-mini-2025-04-14", "chat"],
  ["us/gpt-4.1-nano-2025-04-14", "chat"],
  ["us/gpt-4o-2024-08-06", "chat"],
  ["us/gpt-4o-2024-11-20", "chat"],
  ["us/gpt-4o-mini-2024-07-18", "chat"],
  ["us/gpt-4o-mini-realtime-preview-2024-12-17", "chat"],
  ["us/gpt-4o-realtime-preview-2024-10-01", "chat"],
  ["us/gpt-4o-realtime-preview-2024-12-17", "chat"],
  ["us/gpt-5-2025-08-07", "chat"],
  ["us/gpt-5-mini-2025-08-07", "chat"],
  ["us/gpt-5-nano-2025-08-07", "chat"],
  ["us/gpt-5.1", "chat"],
  ["us/gpt-5.1-chat", "chat"],
  ["us/gpt-5.1-codex", "responses"],
  ["us/gpt-5.1-codex-mini", "responses"],
  ["us/o1-2024-12-17", "chat"],
  ["us/o1-mini-2024-09-12", "chat"],
  ["us/o1-preview-2024-09-12", "chat"],
  ["us/o3-2025-04-16", "chat"],
  ["us/o3-mini-2025-01-31", "chat"],
  ["us/o4-mini-2025-04-16", "chat"],
] as const;

const AZURE_OPENAI_MODELS: RegistryModel[] = AZURE_OPENAI_MODEL_DEFINITIONS.map(
  ([id, apiType]) => ({
    id,
    name: id,
    ...(apiType === "responses" ? { targetFormat: "openai-responses" } : {}),
  })
);
...
const BEDROCK_MODELS: RegistryModel[] = BEDROCK_MODEL_IDS.map((id) => ({
  id,
  name: id,
}));

const SAGEMAKER_MODEL_IDS = [
...
const SAGEMAKER_MODELS: RegistryModel[] = SAGEMAKER_MODEL_IDS.map((id) => ({
  id,
  name: id,
}));
...
export const REGISTRY: Record<string, RegistryEntry> = {
  ...
  github: {
    ...
    models: [
      ...
      { id: "gpt-5", name: "GPT-5", supportsReasoning: true, contextLength: 200000 },
      { id: "gpt-5-mini", name: "GPT-5 Mini", supportsReasoning: true, contextLength: 128000 },
      {
        id: "gpt-5-codex",
        name: "GPT-5 Codex",
      ...
      { id: "gpt-5.1", name: "GPT-5.1", supportsReasoning: true, contextLength: 200000 },
      {
        id: "gpt-5.1-codex",
        name: "GPT-5.1 Codex",
        supportsReasoning: true,
      ...
      { id: "claude-opus-4.1", name: "Claude Opus 4.1", contextLength: 128000 },
      {
        id: "claude-opus-4.6",
      ...
      { id: "gemini-3-pro-preview", name: "Gemini 3 Pro Preview", contextLength: 1048576 },
      { id: "gemini-3.1-pro-preview", name: "Gemini 3.1 Pro Preview", contextLength: 173000 },
      ...
      { id: "gemini-3-flash-preview", name: "Gemini 3 Flash Preview", contextLength: 173000 },
      { id: "grok-code-fast-1", name: "Grok Code Fast 1", contextLength: 128000 },
      { id: "oswe-vscode-prime", name: "Raptor Mini", contextLength: 128000 },
    ],
  },
  ...
  kiro: {
    ...
    models: [
      ...
      { id: "kiro-auto", name: "Kiro Auto", supportsReasoning: true, contextLength: 200000 },
      {
      ...
      { id: "kiro-gpt-4o", name: "Kiro GPT-4o", contextLength: 128000 },
      { id: "kiro-gpt-4", name: "Kiro GPT-4", contextLength: 128000 },
      { id: "kiro-gpt-4-turbo", name: "Kiro GPT-4 Turbo", contextLength: 128000 },
      { id: "kiro-gpt-3-5-turbo", name: "Kiro GPT-3.5 Turbo", contextLength: 16384 },
      {
      ...
      },
      {
        ...
        name: "Kiro Claude Sonnet 4.6 (Agentic)",
        supportsReasoning: true,
        contextLength: 200000,
      },
      {
  ...
  "amazon-q": {
    ...
    models: [
      { id: "amazon-q-developer", name: "Amazon Q Developer", contextLength: 200000 },
      { id: "amazonq-auto", name: "Amazon Q Auto", contextLength: 200000 },
      { id: "amazonq-claude-opus-4.5", name: "Amazon Q Claude Opus 4.5", contextLength: 200000 },
      {
        id: "amazonq-claude-sonnet-4.5",
        name: "Amazon Q Claude Sonnet 4.5",
        contextLength: 200000,
      },
      { id: "amazonq-claude-sonnet-4", name: "Amazon Q Claude Sonnet 4", contextLength: 200000 },
      {
        id: "amazonq-claude-haiku-4.5",
        name: "Amazon Q Claude Haiku 4.5",
        contextLength: 200000,
      },
    ],
  },
  ...
  glhf: {
    ...
    models: [
      ...
      { id: "hf:meta-llama/Llama-3.3-70B-Instruct", name: "Llama 3.3 70B" },
    ],
    passthroughModels: true,
  },
  cablyai: {
  ...
  fenayai: {
    ...
    format: "openai",
    executor: "default",
    baseUrl: "https://api.fenay.ai/v1/chat/completions",
    authType: "apikey",
    authHeader: "bearer",
    models: [],
    passthroughModels: true,
  ...
  "nous-research": {
    ...
    models: [
      ...
      { id: "qwen/qwen3.5-plus-02-15", name: "Qwen 3.5 Plus 02-15" },
      ...
      { id: "arcee-ai/trinity-large-thinking", name: "Arcee Trinity Large Thinking" },
  ...
  gradient: {
    ...
    format: "openai",
    executor: "default",
    baseUrl: "https://apis.gradient.network/api/v1/ai/chat/completions",
    modelsUrl: "https://apis.gradient.network/api/v1/ai/models",
    authType: "apikey",
    authHeader: "bearer",
    models: [
      { id: "gpt-oss-120b", name: "GPT OSS 120B" },
      { id: "qwen3-235b-a22b", name: "Qwen3 235B A22B" },
      {
        ...
        name: "Qwen3 Coder 480B Instruct FP8",
      },
    ],
    passthroughModels: true,
  },
  replicate: {
    ...
    authHeader: "bearer",
    models: [
      { id: "meta/llama-2-13b", name: "meta/llama-2-13b", contextLength: 4096 },
      { id: "meta/llama-2-13b-chat", name: "meta/llama-2-13b-chat", contextLength: 4096 },
      { id: "meta/llama-2-70b", name: "meta/llama-2-70b", contextLength: 4096 },
      { id: "meta/llama-2-70b-chat", name: "meta/llama-2-70b-chat", contextLength: 4096 },
      { id: "meta/llama-2-7b", name: "meta/llama-2-7b", contextLength: 4096 },
      { id: "meta/llama-2-7b-chat", name: "meta/llama-2-7b-chat", contextLength: 4096 },
      { id: "meta/llama-3-70b", name: "meta/llama-3-70b", contextLength: 8192 },
      { id: "meta/llama-3-70b-instruct", name: "meta/llama-3-70b-instruct", contextLength: 8192 },
      { id: "meta/llama-3-8b", name: "meta/llama-3-8b", contextLength: 8086 },
      { id: "meta/llama-3-8b-instruct", name: "meta/llama-3-8b-instruct", contextLength: 8086 },
      {
        id: "mistralai/mistral-7b-instruct-v0.2",
        name: "mistralai/mistral-7b-instruct-v0.2",
        contextLength: 4096,
      },
      { id: "mistralai/mistral-7b-v0.1", name: "mistralai/mistral-7b-v0.1", contextLength: 4096 },
      {
      ...
      { id: "deepseek-ai/deepseek-v3", name: "deepseek-ai/deepseek-v3", contextLength: 65536 },
      ...
      { id: "deepseek-ai/deepseek-v3.1", name: "deepseek-ai/deepseek-v3.1", contextLength: 163840 },
      { id: "xai/grok-4", name: "xai/grok-4" },
      { id: "deepseek-ai/deepseek-r1", name: "deepseek-ai/deepseek-r1", contextLength: 65536 },
    ],
    passthroughModels: true,
  },
  voyage: {
    ...
    authHeader: "bearer",
    models: [
      { id: "voyage-3-large", name: "Voyage 3 Large", contextLength: 32000 },
      { id: "voyage-3", name: "Voyage 3", contextLength: 32000 },
      { id: "voyage-3-lite", name: "Voyage 3 Lite", contextLength: 32000 },
      { id: "voyage-code-3", name: "Voyage Code 3", contextLength: 32000 },
      { id: "rerank-2.5", name: "Rerank 2.5", contextLength: 32000 },
      { id: "rerank-2.5-lite", name: "Rerank 2.5 Lite", contextLength: 32000 },
    ],
  },
  jina: {
    id: "jina",
  ...
  "vertex-partner": {
    ...
    authHeader: "bearer",
    models: [
      { id: "meta/llama3-405b-instruct-maas", name: "Llama 3 405B (Vertex Partner)" },
      { id: "anthropic/claude-3-5-sonnet", name: "Claude 3.5 Sonnet (Vertex Partner)" },
    ],
    passthroughModels: true,
  },
  "azure-openai": {
  ...
  "azure-ai": {
    ...
    format: "openai",
    executor: "azure-ai",
    baseUrl: "https://example.models.ai.azure.com",
    authType: "apikey",
    authHeader: "api-key",
    models: AZURE_AI_CHAT_MODELS,
  },
  runwayml: {
    id: "runwayml",
    alias: "runwayml",
    format: "openai",
    executor: "default",
    baseUrl: "https://api.runwayml.com/v1/video/generation",
    authType: "apikey",
    authHeader: "bearer",
    models: [{ id: "gen-3-alpha", name: "Gen-3 Alpha" }],
  },

  // ── Phase 3: OAuth & Special ──
  zed: {
    id: "zed",
    alias: "zed",
    format: "openai",
    executor: "zed",
    baseUrl: "https://ai.zed.dev/completion",
    authType: "oauth",
    authHeader: "custom",
    models: [
      { id: "claude-3-5-sonnet", name: "Claude 3.5 Sonnet (Zed)" },
      { id: "claude-3-haiku", name: "Claude 3 Haiku (Zed)" },
    ],
    passthroughModels: true,
  },
  trae: {
    ...
    authType: "oauth",
    authHeader: "bearer",
    models: [{ id: "claude-3-5-sonnet", name: "Claude 3.5 Sonnet (Trae)" }],
    passthroughModels: true,
  },
  amp: {
    id: "amp",
    ...
    format: "openai",
    executor: "amp",
    baseUrl: "https://api.ampcode.com/v1",
    authType: "apikey",
    authHeader: "bearer",
    models: [
      { id: "claude-opus-4-5-20251101", name: "Amp Claude Opus 4.5" },
      { id: "claude-sonnet-4-5-20250929", name: "Amp Claude Sonnet 4.5" },
      { id: "claude-haiku-4-5-20251001", name: "Amp Claude Haiku 4.5" },
    ],
  },
  reka: {
    id: "reka",
  ...
  "nlp-cloud": {
    ...
    format: "openai",
    executor: "default",
    baseUrl: "https://api.nlpcloud.io/v1/gpu/chat/completions",
    authType: "apikey",
    authHeader: "token",
    models: [],
    passthroughModels: true,
  ...
  "you-com": {
    ...
    format: "openai",
    executor: "default",
    baseUrl: "https://api.ydc-index.io/rag",
    authType: "apikey",
    authHeader: "bearer",
    models: [
      { id: "you-smart", name: "You Smart" },
      { id: "you-research", name: "You Research" },
    ],
  },
  ...
  sagemaker: {
    ...
    format: "openai",
    executor: "sagemaker",
    baseUrl: "https://runtime.sagemaker.us-east-1.amazonaws.com/endpoints",
    authType: "apikey",
    authHeader: "bearer",
    models: SAGEMAKER_MODELS,
    passthroughModels: true,
  },
  sap: {
    id: "sap",
    ...
    format: "openai",
    executor: "sap",
    baseUrl: "https://api.ai.prod.eu-central-1.aws.ml.hana.ondemand.com/v2/inference/deployments",
    authType: "apikey",
    authHeader: "bearer",
    models: [
  ...
  "gitlab-duo": {
    ...
    authHeader: "bearer",
    models: [
      { id: "duo-chat-sonnet-4-6", name: "GitLab Duo Claude Sonnet 4.6", targetFormat: "claude" },
      { id: "duo-chat-opus-4-6", name: "GitLab Duo Claude Opus 4.6", targetFormat: "claude" },
      { id: "duo-chat-opus-4-5", name: "GitLab Duo Claude Opus 4.5", targetFormat: "claude" },
      { id: "duo-chat-sonnet-4-5", name: "GitLab Duo Claude Sonnet 4.5", targetFormat: "claude" },
      { id: "duo-chat-haiku-4-5", name: "GitLab Duo Claude Haiku 4.5", targetFormat: "claude" },
      { id: "duo-chat-gpt-5-2-codex", name: "GitLab Duo GPT-5.2 Codex" },
      { id: "duo-chat-gpt-5-2", name: "GitLab Duo GPT-5.2" },
      { id: "duo-chat-gpt-5-1", name: "GitLab Duo GPT-5.1" },
      { id: "duo-chat-gpt-5-mini", name: "GitLab Duo GPT-5 Mini" },
      { id: "duo-chat-gpt-5-codex", name: "GitLab Duo GPT-5 Codex" },
    ],
    passthroughModels: true,
  },
  chutes: {
  ...
  codebuddy: {
    ...
    authHeader: "x-api-key",
    models: [
      { id: "auto", name: "CodeBuddy Auto", contextLength: 128000 },
      ...
      { id: "deepseek-v3-2-volc", name: "DeepSeek V3.2 (Volc)", contextLength: 128000 },
    ],
    passthroughModels: true,
  },
  "gitlab-duo-oauth": {
  ...
  blockrun: {
    ...
    format: "openai",
    executor: "default",
    baseUrl: "https://api.blockrun.ai/v1/chat/completions",
    authType: "apikey",
    authHeader: "bearer",
    models: [],
    passthroughModels: true,
  ...
  manus: {
    ...
    format: "openai",
    executor: "default",
    baseUrl: "https://api.manus.ai/v1/chat/completions",
    authType: "apikey",
    authHeader: "bearer",
    models: [],
    passthroughModels: true,
  ...
  "pydantic-ai": {
    ...
    format: "openai",
    executor: "default",
    baseUrl: "https://api.pydantic.ai/v1/chat/completions",
    authType: "apikey",
    authHeader: "bearer",
    models: [],
    passthroughModels: true,
  ...
  langgraph: {
    ...
    format: "openai",
    executor: "default",
    baseUrl: "https://api.langgraph.com/v1/chat/completions",
    authType: "apikey",
    authHeader: "bearer",
    models: [],
    passthroughModels: true,
  ...
  lemonade: {
    ...
    format: "openai",
    executor: "default",
    baseUrl: "https://api.lemonade.ai/v1/chat/completions",
    authType: "apikey",
    authHeader: "bearer",
    models: [],
    passthroughModels: true,
  ...
  clarifai: {
    ...
    format: "openai",
    executor: "default",
    baseUrl: "https://api.clarifai.com/v2/chat/completions",
    authType: "apikey",
    authHeader: "key",
    models: [],
    passthroughModels: true,
  ...
  empower: {
    ...
    format: "openai",
    executor: "default",
    baseUrl: "https://api.empower.dev/v1/chat/completions",
    authType: "apikey",
    authHeader: "bearer",
    models: [],
    passthroughModels: true,
