 ...
 * under what name.
 *
 * Reference: ADR-031 (Tier-1 router = maximhq/bifrost), SPEC.md § 3
 * (architecture overview), docs/adr/0031-bifrost-tier1-router.md.
 *
...
export const BIFROST_PROVIDER_MAP: Record<string, BifrostProviderEntry> = {
  ...
  azure: { bifrostId: "azure", status: "native", note: "Azure OpenAI; deployments map via modelOverride below." },
  ...
  ollama: { bifrostId: "ollama", status: "native", note: "Local; Bifrost talks to local Ollama daemon." },
  ...
  "claude-web": { bifrostId: null, status: "unsupported", note: "Web-cookie provider; not a Bifrost use case." },
  ...
  cliproxyapi: { bifrostId: null, status: "unsupported", note: "Custom CLIProxyAPI executor; use open-sse/executors/cliproxyapi.ts." },
