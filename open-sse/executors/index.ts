...
import { MonkeyCodeAiExecutor } from "./monkeycode-ai.ts";
...
const executors = {
  ...
  "monkeycode-ai": new MonkeyCodeAiExecutor(),
  monkeycode: new MonkeyCodeAiExecutor(), // Alias
...
export { MonkeyCodeAiExecutor } from "./monkeycode-ai.ts";
