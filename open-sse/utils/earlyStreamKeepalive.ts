 ...
 * the public URL, method, headers and body stream: Next.js may proxy the request,
 * and passing that proxy to Node's Request constructor fails its private-slot check.
 *
