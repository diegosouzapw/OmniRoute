...
export const COLLECTORS = [
  ...
  {
    glob: "tests/unit/{api,auth,authz,build,cli,cli-helper,combo,compression,correctness,cors,dashboard,db,db-adapters,docs,gamification,guardrails,health,lib,mcp,observability,runtime,security,services,settings,shared,ui}/**/*.test.ts",
