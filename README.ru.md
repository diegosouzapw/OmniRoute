...
| `diegosouzapw/omniroute` | `0.8.8`  | ~250MB | Текущая версия             |
...
- OmniRoute v0.8.8+ включает fallback-валидацию через chat completions
...
- **Runtime**: Node.js 20+
- **Язык**: TypeScript 5.9 — **100% TypeScript** в `src/` и `open-sse/` (v0.8.8)
